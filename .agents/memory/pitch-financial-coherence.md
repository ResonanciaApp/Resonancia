...
**Fórmulas escenarios (Anexo valoración):** ARR neto = subs × $3.300 × 12 / 900 (US$); valoración = múltiplo × ARR (6×/7×/8× → US$3,2M/4,6M/8,8M Base/Opt/Agr); stake = 3% × valoración (US$96K/138K/264K); retorno = stake / US$30K (= valoración en US$M: 3,2×/4,6×/8,8×).
