...
- Costos operacionales por fase (sep 2026): fijos $2,58M/mes en M1–M4 y $4,15M desde M5; contenido estable $0,45M/mes; marketing sin cambios. **Why:** la estructura de RRHH y operación se amplía desde M5. **How to apply:** usar una curva mensual, nunca un fijo anual único; M3 debe conservar su ejemplo y los resultados derivados deben salir del modelo central.
- Escala de inversión (sep 2026): 21 escenarios enteros de $1M a $21M; anclajes exactos $8M=6,5% y $21M=20%; la participación marginal acelera +0,0215 pp por millón. **Why:** premiar aportes mayores con una mejora suave y uniforme. **How to apply:** preservar ambos anclajes y la aceleración constante; no volver a tramos manuales aislados.
...
- Ronda previa a operar (sep 2026): $21,05M = contenido $4,3M + marketing $2,5M + runway 3 meses $2,25M + externos $8M + equipamiento $2,8M + otros $1,2M. **Why:** presupuesto explícito confirmado por el usuario; $750 mil/mes exige rotular 3 meses. **How to apply:** usar este desglose literalmente en la lámina de inversión; no sustituye por sí solo los supuestos mensuales del P&L.
- Tramos de inversión aprobados (sep 2026): $3M/2%, $6M/4,5%, $8M/6,5% y ronda completa $21,05M/17,6%. **Why:** el tramo completo conserva aproximadamente la valoración pre-money del acuerdo anterior. **How to apply:** mostrar términos y retornos como estimativos y sujetos a acuerdo definitivo.
...
- Modelo comercial aprobado (sep 2026): M1 solo Premium (70% mensual $1.990 / 30% anual $19.990); M2 Premium normal; M3+ 65% Premium / 35% Plus y 65% mensual / 35% anual dentro de cada nivel. Churn 15% solo para mensuales; anuales permanecen activos durante el período pagado. **Why:** aplicar churn mensual a prepagos anuales sin devoluciones rompía ingresos, caja y activos; además, 65% anual se consideró poco realista para una app nueva. **How to apply:** toda proyección debe conservar precio y modalidad por cohorte, separar P&L de caja y cerrar M12 en 4.400/7.000/9.000 activos.
