...
Inicio 3 activa el sticky cuando el scroll cubre 185 px de la PARTE SUPERIOR del hero (`scrollY=185`), no cerca de su borde inferior. Logo a la izquierda; a la derecha, loto y luego lupa con fondo. El sticky reutiliza el ancho de 62 px y el gap del hero para que la separación visual sea idéntica.
