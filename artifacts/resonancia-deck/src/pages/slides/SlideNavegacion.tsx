...
function IconHome({ size = "2vw", color = "#C69B4F" }: { size?: string; color?: string }) {
  return (
...
function IconBookOpen({ size = "2vw", color = "#C69B4F" }: { size?: string; color?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: size, height: size, flexShrink: 0 }}>
...
function IconSliders({ size = "2vw", color = "#C69B4F" }: { size?: string; color?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: size, height: size, flexShrink: 0 }}>
...
function IconUser({ size = "2vw", color = "#C69B4F" }: { size?: string; color?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: size, height: size, flexShrink: 0 }}>
...
export default function SlideNavegacion() {
  return (
    <div
      ...
      style={{ backgroundColor: "#18110C", color: "#EDE1D3", display: "flex", flexDirection: "column" }}
    >
      {/* Header */}
      <div style={{
        ...
        <h2 style={{ fontSize: "3vw", fontWeight: 300, color: "#EDE1D3", margin: 0, letterSpacing: "-0.02em" }}>
          4 secciones, <span style={{ fontWeight: 700, color: "#C69B4F" }}>todo organizado.</span>
        </h2>
      </div>
          ...
          <div key={tab.name} style={{
            ...
            <div style={{ position: "relative", width: "100%" }}>
              ...
              <div style={{
                ...
                width: "90%", height: "90%",
                borderRadius: "50%",
                background: "radial-gradient(ellipse, rgba(198,155,79,0.08) 0%, transparent 70%)",
                zIndex: 0,
              }} />
              <div style={{
                position: "relative",
            ...
            <div style={{ textAlign: "center", width: "100%" }}>
              {/* Divider */}
              <div style={{ width: "2vw", height: "1px", backgroundColor: "rgba(198,155,79,0.35)", margin: "0 auto 1.5vh" }} />
              {/* Icon + name */}
              ...
              {/* Description */}
              <div style={{ fontSize: "1.1vw", color: "#7a6050", lineHeight: 1.5, padding: "0 0.5vw" }}>{tab.desc}</div>
            </div>
          </div>
        ))}
      </div>
