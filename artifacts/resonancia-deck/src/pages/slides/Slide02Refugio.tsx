    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <h2 style={{ fontSize: "3vw", fontWeight: 300, color: "#EDE1D3", margin: 0, letterSpacing: "-0.02em" }}>
            Tu refugio <span style={{ fontWeight: 700, color: "#BE9650" }}>personal</span>
          </h2>
        </div>

        {/* Body */}
        <div>
          <div style={{ fontSize: "1.6vw", color: "#7A8FA8", marginBottom: "5vh", lineHeight: 1.5 }}>
            Una experiencia diseñada para acompañarte.
          </div>

          <div style={{ display: "flex", alignItems: "flex-start", gap: "1.5vw", marginBottom: "4vh" }}>
            <div style={{ width: "0.65vw", height: "0.65vw", borderRadius: "50%", backgroundColor: "#BE9650", marginTop: "0.9vh", flexShrink: 0 }} />
            <div>
              <div style={{ fontSize: "2vw", fontWeight: 600, color: "#EDE1D3", marginBottom: "0.8vh" }}>Onboarding personalizado</div>
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>Por nombre y momento del día, desde el primer uso.</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: "1.5vw", marginBottom: "4vh" }}>
            <div style={{ width: "0.65vw", height: "0.65vw", borderRadius: "50%", backgroundColor: "#BE9650", marginTop: "0.9vh", flexShrink: 0 }} />
            <div>
              <div style={{ fontSize: "2vw", fontWeight: 600, color: "#EDE1D3", marginBottom: "0.8vh" }}>Estética serena y profunda</div>
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>Azul profundo, dorado y calma en cada pantalla.</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: "1.5vw" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>Totalmente en español, con sensibilidad local.</div>
            </div>
          </div>
        </div>
      ...
      <div style={{ width: "42vw", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", flexShrink: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ width: "100%", height: "100%", borderRadius: "2.0vw", overflow: "hidden", backgroundColor: "#060A0F" }}>
