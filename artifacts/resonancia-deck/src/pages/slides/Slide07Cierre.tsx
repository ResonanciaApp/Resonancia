...
export default function Slide07Cierre() {
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: "1.4vw", fontWeight: 700, letterSpacing: "-0.05em", color: "#060A0F", marginBottom: "1.5vh" }}>
          RESONANCIA
        </div>
        <div style={{ width: "4vw", height: "0.4vh", backgroundColor: "#060A0F", marginBottom: "6vh" }} />
        <div style={{ fontSize: "5.5vw", fontWeight: 700, color: "#060A0F", lineHeight: 1.05, letterSpacing: "-0.03em", marginBottom: "0.3vh" }}>
          Casa del
        </div>
        <div style={{ fontSize: "5.5vw", fontWeight: 300, color: "#060A0F", lineHeight: 1.05, letterSpacing: "-0.03em", marginBottom: "4vh" }}>
          Cuenco.
        </div>
        <div style={{ fontSize: "1.5vw", color: "rgba(6, 10, 15,0.55)", maxWidth: "27vw", lineHeight: 1.55 }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "5.5vh" }}>
          ...
          <div>
            <div style={{ fontSize: "1vw", color: "#7A8FA8", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: "1.5vh" }}>Año</div>
