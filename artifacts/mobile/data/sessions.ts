...
export const SESSIONS: Session[] = [
  ...
  // ── Descanso — ASMR (contenido de prueba) ───────────────────────────────
  {
    ...
    duration: 20,
    durationLabel: "20 min",
    description: "Susurros suaves y cercanos que activan la respuesta sensorial del cuerpo, disolviendo la tensión hasta llevarte al sueño.",
  ...
  },
  {
    ...
    duration: 18,
    durationLabel: "18 min",
    description: "El roce del papel, la tela y los objetos cotidianos crean una capa de sonido íntimo que relaja el sistema nervioso poco a poco.",
