...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subtitle: "Meditaciones con sonidos de cuencos y gongs",
    icon: "eye",
    sessionCount: 12,
    color: "#C69B4F",
    gradient: ["#3C2415", "#24160F"],
  ...
  {
    id: "sesiones-de-sonido",
    title: "Sesiones de Sonido",
    subtitle: "Experiencias sonoras transformadoras",
    icon: "music",
    sessionCount: 0,
    color: "#C69B4F",
    gradient: ["#3A1F0A", "#24160F"],
  },
];
