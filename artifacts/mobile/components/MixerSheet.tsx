...
const ITEM_H = 73; // height of each slot (row content ~54px + 11px gap between items)
...
const styles = StyleSheet.create({
  ...
  trackName: { fontSize: 12, fontWeight: "700", marginBottom: -2, paddingLeft: 8, marginTop: 10 },
  _reorderPill_unused: {
    flexDirection: "row",
    alignItems: "center",
    borderWidth: 1,
