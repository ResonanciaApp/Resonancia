...
export function WeeklyStreakStrip() {
  ...
  return (
    <View style={styles.card}>
      {/* Anillo de progreso */}
      <LinearGradient
        colors={[hexToRgba(brightenHex(theme.gradient[0], 38), 0.15), hexToRgba(brightenHex(theme.gradient[1], 22), 0.11)]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
        style={[styles.ringWrap, {
          ...
          borderWidth: 0.5,
          borderColor: hexToRgba(brightenHex(theme.gradient[0], 10), 0.50),
          shadowColor: "#000000",
