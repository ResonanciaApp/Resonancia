    ...
    <View style={styles.card}>
      ...
      <View style={{ width: COMP_W, height: SVG_H, alignItems: "center", justifyContent: "center", marginTop: -15 }}>
        <Svg width={COMP_W} height={SVG_H} style={StyleSheet.absoluteFill}>
          <Defs>
            {/* Inactiva derecha — sólida todo el camino, sin fade */}
            <SvgGradient id="swInactR" x1={0} y1={0} x2={WAVE_W} y2={0} gradientUnits="userSpaceOnUse">
              <Stop offset="0" stopColor="#714A70" stopOpacity="0.28" />
              <Stop offset="1" stopColor="#714A70" stopOpacity="0.28" />
            </SvgGradient>
            {/* Inactiva izquierda — sólida todo el camino, sin fade */}
            <SvgGradient id="swInactL" x1={0} y1={0} x2={-WAVE_W} y2={0} gradientUnits="userSpaceOnUse">
              <Stop offset="0" stopColor="#714A70" stopOpacity="0.28" />
              <Stop offset="1" stopColor="#714A70" stopOpacity="0.28" />
            </SvgGradient>
            {/* Activa derecha: dorada sólida hasta el borde del progreso, corte abrupto */}
            <SvgGradient id="swGradR" x1={0} y1={0} x2={WAVE_W} y2={0} gradientUnits="userSpaceOnUse">
              ...
              <Stop offset={Math.max(0, fadeEnd - 0.001)} stopColor={waveMid}  stopOpacity={progress > 0 ? 1 : 0} />
          ...
          <G transform={`translate(${RIGHT_START}, ${CY})`}>
            ...
            {/* Círculo sólido en la punta exterior */}
            <Circle cx={WAVE_W} cy={0} r={3} fill="#714A70" fillOpacity={0.28} />
          </G>
