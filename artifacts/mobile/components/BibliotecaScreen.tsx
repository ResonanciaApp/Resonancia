...
const styles = StyleSheet.create({
  ...
  chipRowActions: { flexDirection: "row", alignItems: "center", gap: 2, position: "absolute", right: H_PAD, top: 0, bottom: 0, marginTop: 29, zIndex: 3 },
  ...
  chipRowContent: { flexDirection: "row", gap: 12, paddingTop: 5, paddingBottom: 2, paddingLeft: H_PAD + 4, paddingRight: H_PAD },
  chipRowFiltered: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  chip: {
    paddingVertical: 6,
    width: (width - (H_PAD + 4) - H_PAD - 12) / 2,
    height: 46,
    borderRadius: 15,
