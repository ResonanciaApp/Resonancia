...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700", letterSpacing: 0.2 },
  metaRow: { flexDirection: "row", alignItems: "center", marginTop: 2 },
  sub: { fontFamily: "Manrope", fontSize: 12 },
  ...
  editText: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600" },
});
