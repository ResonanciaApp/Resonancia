...
export function IconCuencoTibetano({ size = 24, color = "#BE8744" }: Props) {
  const s = size;
  return (
...
export function IconCuencoCuarzo({ size = 24, color = "#BE8744" }: Props) {
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
      {/* Bowl - más redondeado */}
...
export function IconMixCuencos({ size = 24, color = "#BE8744" }: Props) {
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
...
export function IconGong({ size = 24, color = "#BE8744" }: Props) {
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
      {/* Outer ring */}
...
export function IconCuencosYGongs({ size = 24, color = "#BE8744" }: Props) {
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
      {/* Mini bowl left */}
...
export function IconSelva({ size = 24, color = "#BE8744" }: Props) {
  const s = size;
  return (
    <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
      {/* Leaf shape */}
