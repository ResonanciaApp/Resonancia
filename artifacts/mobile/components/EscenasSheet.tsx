          ...
          >
            ...
            <View style={styles.previewSection}>
              <View style={styles.previewSectionHeader}>
                <Feather name="volume-2" size={15} color="rgba(255,255,255,0.65)" />
                <Text style={styles.previewSectionLabel}>Volumen de la escena</Text>
              </View>
              <View style={styles.previewSliderRow}>
                <Feather name="volume-1" size={13} color="rgba(255,255,255,0.4)" />
                <View style={{ flex: 1 }}>
                  <VolumeSlider
                    value={volume}
                    onChange={setVolume}
                ...
                <Feather name="volume-2" size={13} color="rgba(255,255,255,0.4)" />
              </View>
            </View>
            ...
            >
              <View style={styles.previewSectionHeader}>
                <Feather name="clock" size={15} color="rgba(255,255,255,0.65)" />
                <Text style={[styles.previewSectionLabel, { flex: 1 }]}>
                  Reproducir fuera de la app
                </Text>
                <View style={styles.timerTrigger}>
                  <Text style={[styles.timerTriggerLabel, { color: "rgba(255,255,255,0.6)" }]}>
                    {(
                      TIMER_OPTIONS.find((o) => o.value === timerMinutes)?.label ?? "Sin límite"
                    ).toUpperCase()}
                  </Text>
