...
const styles = StyleSheet.create({
  ...
  dividerText: { color: COLORS.muted, fontSize: 12, fontFamily: "Jost" },
  btn: {
    flexDirection: "row",
    alignItems: "center",
  ...
  btnText: { color: COLORS.fg, fontFamily: "OptimaBold", fontSize: 15 },
  googleG: { color: "#EA4335", fontSize: 18, fontFamily: "OptimaBold" },
