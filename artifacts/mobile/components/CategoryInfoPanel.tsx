  ...
  return (
    <View style={[styles.wrapper, { borderTopColor: accentColor + "33" }]}>
      ...
      <Pressable
        ...
        style={({ pressed }) => [
          styles.toggle,
          { backgroundColor: "rgba(255,255,255,0.05)", borderColor: "transparent", opacity: pressed ? 0.75 : 1 },
        ]}
      >
      ...
      {open && (
        <View style={styles.content}>
          ...
          {items.map((item, i) => (
            <View
              key={i}
              style={[styles.card, { backgroundColor: "rgba(255,255,255,0.05)", borderColor: "transparent" }]}
            >
