            ...
            {NAV_TABS.map((tab) => {
              ...
              return (
                <React.Fragment key={tab.id}>
                  ...
                  >
                    <LinearGradient
                      colors={sel ? ["#D6A45C", "#BE8744"] : ["rgba(190,150,80,0.09)", "rgba(190,150,80,0.03)"]}
                      start={{ x: 0, y: 0 }}
                      end={{ x: 0, y: 1 }}
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 20, fontWeight: "700", letterSpacing: 0.5, marginBottom: 16, color: "#FAF0EE" },
