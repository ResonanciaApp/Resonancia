...
export default function HomeScreen2() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: activeTheme.gradient[0] }]}>
      ...
      >
        {/* ── Racha semanal ── */}
        <View style={{ paddingHorizontal: GRID_PAD, marginBottom: SECTION_GAP / 2, marginTop: 188 }}>
          <WeeklyStreakStrip />
        </View>
        ...
        {/* ── SESIÓN DESTACADA ── */}
        {filteredFeatured && (
          <View style={[styles.section, { marginBottom: SECTION_GAP, marginTop: 7 }]}>
      ...
      >
        ...
        <View style={{ width: 210, height: 44, justifyContent: "center" }}>
          <Animated.Image
            ...
            style={{ position: "absolute", width: 160, height: 44, opacity: logoAnim5, left: -10 }}
            resizeMode="contain"
          />
