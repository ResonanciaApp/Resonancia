    ...
    <View style={[styles.root, { backgroundColor: activeTheme.gradient[0] }]}>
      ...
      >
        ...
        <LinearGradient
          ...
          pointerEvents="none"
        />
        <Animated.View style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 220, opacity: imageFade }} pointerEvents="none">
          <LinearGradient
      ...
      >
        {/* ── Racha semanal ── */}
        <View style={{ paddingHorizontal: GRID_PAD, marginBottom: SECTION_GAP / 2, marginTop: 238 }}>
          <WeeklyStreakStrip />
        </View>
      ...
      >
        ...
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center", height: 44 }}>
          <Animated.Image
            ...
            style={{ position: "absolute", width: 167, height: 44, opacity: logoOpacity }}
            resizeMode="contain"
          />
