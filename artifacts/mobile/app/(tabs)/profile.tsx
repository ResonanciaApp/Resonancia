                ...
                {sel && (activeTheme?.id === "tibet"
                  ...
                  : activeTheme?.id === "vino-tinto"
                    ...
                    : activeTheme?.id === "indigo"
                      ? <LinearGradient colors={["#EADFB8", "#DCCB97"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={StyleSheet.absoluteFill} />
...
const styles = StyleSheet.create({
  ...
  pillText: { fontFamily: "Manrope", fontSize: 11, fontWeight: "700", color: "#F4F4F4" },
