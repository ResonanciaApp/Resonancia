  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.statsRow}>
          {stats.map((stat) => {
            ...
            if (stat.href) {
              return (
                <Pressable
                  ...
                  style={({ pressed }) => [
                    styles.statCard,
                    { backgroundColor: "#100B05", borderColor: colors.border, opacity: pressed ? 0.8 : 1 },
                  ]}
                >
                  {content}
                </Pressable>
            ...
            return (
              <View
                key={stat.label}
                style={[styles.statCard, { backgroundColor: "#100B05", borderColor: colors.border }]}
              >
                {content}
              </View>
            );
        ...
        {/* ── Racha ── */}
        <View style={[styles.streakCard, { backgroundColor: "#100B05", borderColor: colors.border }]}>
        ...
        <View style={styles.section}>
          ...
          {activity.hasData ? (
            <View style={[styles.journeyCard, { backgroundColor: "#100B05", borderColor: colors.border }]}>
            ...
            <View style={[styles.emptyFav, { backgroundColor: "#100B05", borderColor: colors.border }]}>
