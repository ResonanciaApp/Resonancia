...
const PillTab = memo(function PillTab({
  ...
  return (
    ...
    >
      {/* Fondo seleccionado */}
      {sel && (
        <View style={[StyleSheet.absoluteFill, { borderRadius: 999, overflow: "hidden", backgroundColor: "#F9F9F9" }]} />
      )}
...
const styles = StyleSheet.create({
  ...
  subTabText: { fontFamily: "Manrope", fontSize: 14, letterSpacing: 0.3, fontWeight: "450", includeFontPadding: false },
