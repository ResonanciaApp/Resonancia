    ...
    >
      <View style={[
        ...
        <View style={styles.pillIconGlow}>
          <MaterialCommunityIcons name={tab.icon as any} size={23} color={sel ? "#FFFFFF" : "#1A0A2E"} />
        </View>
        <Text numberOfLines={1} style={[styles.pillTabLabel, { color: sel ? "#FFFFFF" : "#1A0A2E" }]}>
          {tab.label}
        </Text>
      </View>
    </Pressable>
    ...
    >
      ...
      >
        <MaterialCommunityIcons
          ...
          size={26}
          color={sel ? "#FFFFFF" : "#1A0A2E"}
        />
        <Text
          numberOfLines={1}
          style={[styles.pillTabLabel, { color: sel ? "#FFFFFF" : "#1A0A2E" }]}
        >
          {tab.label}
        </Text>
      </View>
...
export default function MiMusicaScreen() {
  ...
  const settingsIconAnim = useRef(new Animated.Value(0)).current;
    ...
    <View style={styles.root}>
      ...
      <View style={styles.inner}>
        ...
        <View style={styles.topPanel}>
          ...
          <View style={{ height: 40 + topPad, width: "100%" }}>
            <Animated.View
              pointerEvents="none"
...
const styles = StyleSheet.create({
  ...
  pillTabLabel: { fontSize: 13, letterSpacing: 0.1, fontWeight: "600" },
