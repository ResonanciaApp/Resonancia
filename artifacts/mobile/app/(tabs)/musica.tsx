...
const TAB_NOCHE_GRID_BG = "#232323";
                      ...
                      return (
                        <Pressable key={catId} onPress={() => setSubTab(sel ? null : catId)}>
                          {sel ? (
                            ...
                            <View style={[styles.subTabBorderOuter, { borderWidth: 1, borderColor: "rgba(255,255,255,0.10)", padding: 0 }]}>
              ...
              <View style={[styles.grid, { marginTop: 4 }]}>
                {displayedSounds.map((s, i) => (
                  <SoundCard
                    ...
                    borderGradient={bgPaletteId === "noche" ? ["#D4AF37", "#D4AF37", "#D4AF37"] : [TAB_GRADIENT[mainTab][0], TAB_HEADER_GRADIENT[mainTab][1], TAB_HEADER_GRADIENT[mainTab][2]]}
...
const styles = StyleSheet.create({
  ...
  cardFooter: { paddingHorizontal: 4, paddingTop: 9, height: 38, overflow: "hidden" },
