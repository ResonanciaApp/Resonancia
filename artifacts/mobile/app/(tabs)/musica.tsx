...
export default function MezcladorScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: "#2A0F4D" }]}>
      <LinearGradient
        colors={["#2A0F4D", "#0E265D"]}
        style={StyleSheet.absoluteFill}
        pointerEvents="none"
      />
...
const styles = StyleSheet.create({
  ...
  subTabText: { fontFamily: "Manrope", fontSize: 11, letterSpacing: 0.1, fontWeight: "700", includeFontPadding: false },
