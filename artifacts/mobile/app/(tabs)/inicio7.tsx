    ...
    <View style={[styles.root, { backgroundColor: activeTheme.gradient[0] }]}>
      ...
      >
        ...
        <Image
          ...
          style={{ width: 133, height: 44, marginLeft: -9 }}
          resizeMode="contain"
        />
        ...
        <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
          <Pressable
            ...
            hitSlop={8}
            style={({ pressed }) => [styles.giftBtn, { opacity: pressed ? 0.8 : 1, marginLeft: 2 }]}
          >
            <View style={[styles.giftBtnInner, { backgroundColor: `${activeTheme.gradient[0]}60` }]}>
