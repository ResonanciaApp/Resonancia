      ...
      >
        ...
        <View style={styles.hero}>
          <Pressable
            ...
            hitSlop={10}
            style={{ width: 38, height: 38, borderRadius: 19, backgroundColor: "rgba(255,255,255,0.10)", alignItems: "center", justifyContent: "center", marginLeft: -5, transform: [{ translateY: -22 }] }}
          >
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 13, width: "100%" }}>
          <Pressable
            onPress={backOverride ?? (() => router.back())}
            hitSlop={10}
            style={{ width: 38, height: 38, borderRadius: 19, backgroundColor: "rgba(255,255,255,0.10)", alignItems: "center", justifyContent: "center", marginLeft: 1, transform: [{ translateY: -22 }] }}
          >
            <View style={{ transform: [{ translateX: -1 }] }}>
              <Feather name="chevron-left" size={28} color="#FBFBFB" />
            </View>
