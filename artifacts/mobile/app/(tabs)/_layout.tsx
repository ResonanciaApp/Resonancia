...
const HIDDEN_ROUTES = new Set(["profile", "biblioteca"]);
  ...
  return (
    <>
      ...
      >
        ...
        {/* 2b. Tinte dorado sutil */}
        <View pointerEvents="none" style={[StyleSheet.absoluteFill, { backgroundColor: "rgba(212,175,55,0.025)" }]} />
