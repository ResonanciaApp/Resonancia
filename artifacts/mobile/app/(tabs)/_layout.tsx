...
const HIDDEN_ROUTES = new Set(["musica", "biblioteca", "profile", "video", "emocion"]);
...
> = {
  ...
  "inicio-copia": { label: "Inicio 2", sfIcon: "square.on.square",  sfIconFill: "square.on.square",      featherIcon: "copy" },
