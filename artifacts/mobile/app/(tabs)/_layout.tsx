...
> = {
  ...
  explore:    { label: "Medita",     sfIcon: "magnifyingglass",     sfIconFill: "magnifyingglass",       featherIcon: "search", image: require("@/assets/images/tab-icon-medita.png"), iconSize: ICON_SIZE + 4, labelOffset: -2 },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#1B060F" }}>
      ...
      >
        ...
        <Tabs.Screen name="musica"         options={{ title: "Crear" }} />
