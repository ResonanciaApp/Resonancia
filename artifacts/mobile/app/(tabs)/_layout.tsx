...
const HIDDEN_ROUTES = new Set(["biblioteca", "musica", "inicio7"]);
...
> = {
  ...
  inicio8:    { label: "Inicio 8",   sfIcon: "house",               sfIconFill: "house.fill",           featherIcon: "home" },
  ...
  return (
    <>
      ...
      >
        ...
        {/* Tinte Universo */}
        {activeSceneId === "tibet" && (
          <View style={[StyleSheet.absoluteFill, { backgroundColor: "rgba(31,42,98,0.20)" }]} pointerEvents="none" />
        )}
