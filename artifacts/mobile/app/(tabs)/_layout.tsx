...
const HIDDEN_ROUTES = new Set(["biblioteca", "musica", "profile"]);
...
> = {
  ...
  encuentros: { label: "Encuentros", sfIcon: "person.3",            sfIconFill: "person.3.fill",         featherIcon: "users", iconSize: 33 },
