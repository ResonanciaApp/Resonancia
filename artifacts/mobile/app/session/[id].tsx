...
export default function SessionDetailScreen() {
  ...
  const CATEGORY_BG: Record<string, {
    ...
    "sonidos-ancestrales":  { gradient: ["#3A0E18", "#290A12"], solid: "#290A12", pillBg: "#4A0C0C", labelGradient: ["#FFF8EE", "#FFEEDD"], labelColor: "#7A1020" },
    "meditaciones-guiadas": { gradient: ["#3A0E18", "#290A12"], solid: "#290A12", pillBg: "#4A0C0C", labelGradient: ["#FFF8EE", "#FFEEDD"], labelColor: "#7A1020" },
    "reflexiones":          { gradient: ["#3A0E18", "#290A12"], solid: "#290A12", pillBg: "#4A0C0C", labelGradient: ["#FFF8EE", "#FFEEDD"], labelColor: "#7A1020" },
    "musica-sonidos":       { gradient: ["#3A0E18", "#290A12"], solid: "#290A12", pillBg: "#4A0C0C", labelGradient: ["#FFF8EE", "#FFEEDD"], labelColor: "#7A1020" },
