...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontFamily: "OptimaBold", marginBottom: 6 },
  subtitle: { fontSize: 14, fontFamily: "Jost", marginBottom: 20 },
  searchRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  searchInput: { flex: 1, fontSize: 14, fontFamily: "Jost" },
  section: { marginBottom: 28, gap: 10 },
  sectionTitle: { fontSize: 16, fontFamily: "OptimaBold", marginBottom: 4 },
  empty: { fontSize: 13, fontFamily: "Jost", paddingVertical: 8 },
  requestCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  initials: { fontSize: 15, fontFamily: "OptimaBold" },
  friendName: { fontSize: 14, fontFamily: "Jost", fontWeight: "600", marginBottom: 2 },
  friendSub: { fontSize: 12, fontFamily: "Jost" },
  ...
  statusBadge: { fontSize: 12, fontFamily: "Jost", fontWeight: "600" },
  unreadBadge: {
    minWidth: 22,
    height: 22,
    borderRadius: 11,
  ...
  unreadText: { color: "#080F0A", fontSize: 11, fontFamily: "OptimaBold" },
  guestCard: {
    borderRadius: 20,
    borderWidth: 1,
    padding: 22,
  ...
  guestTitle: { fontSize: 18, fontFamily: "OptimaBold", textAlign: "center" },
  guestText: { fontSize: 13, fontFamily: "Jost", textAlign: "center", lineHeight: 19, marginBottom: 8 },
  ...
  guestBtnText: { color: "#080F0A", fontFamily: "OptimaBold", fontSize: 15 },
  guestLink: { fontSize: 13, fontFamily: "Jost", fontWeight: "600", marginTop: 4 },
});
