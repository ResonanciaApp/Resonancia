  ...
  return (
    <View style={[styles.root, { backgroundColor: "#070512" }]}>
      ...
      >
        ...
        {creations.length === 0 && (
          <Text style={[styles.emptyHint, { color: "#a79fb8" }]}>
      ...
      >
        <Pressable style={styles.modalBackdrop} onPress={() => setSharingFor(null)}>
          ...
          >
            ...
            <Text style={{ fontSize: 13, color: "#a79fb8", lineHeight: 18 }}>
...
const styles = StyleSheet.create({
  ...
  sheetRowSub: { fontSize: 12, color: "rgba(194,194,194,0.45)", marginTop: 1 },
  exportHidden: {
    position: "absolute",
    left: 0,
    top: 0,
  ...
  sheetCancelText: { fontSize: 14, fontWeight: "600", color: "rgba(194,194,194,0.45)" },
  ...
  confirmBtnGhostText: { fontSize: 14, fontWeight: "600", color: "rgba(194,194,194,0.45)" },
  confirmBtnDanger: {
    flex: 1,
    paddingVertical: 12,
    borderRadius: 12,
