        ...
        <View style={styles.heroArea}>
          ...
          <View style={styles.heroIconFloat}>
            <View style={styles.heroIconGlow}>
              <MaskedView maskElement={<View style={{ width: 56, height: 56, alignItems: "center", justifyContent: "center" }}><Ionicons name="musical-notes-outline" size={56} color="#fff" /></View>}>
