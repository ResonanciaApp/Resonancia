...
export default function MusicaSonidosScreen() {
  ...
  const [activeTab, setActiveTab] = useState<MusicTab>("Música Ambient");
      ...
      >
        ...
        <View style={[styles.header, { paddingHorizontal: H_PAD }]}>
          ...
          <Text style={[styles.pageSub, { color: colors.mutedForeground }]}>
            Composiciones para meditar, sentir y expandir
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  // Tab bar (same design as Ancestrales subcategory)
  tabBarWrap: {
    paddingBottom: 0,
  },
  tabBar: {
