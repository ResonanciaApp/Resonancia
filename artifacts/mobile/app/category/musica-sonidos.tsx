      ...
      >
        ...
        <View style={[styles.heroArea, { height: topPad + 48 }]}>
          ...
          <View style={[styles.heroOverlayRight, { top: topPad - 16 }]}>
            <Pressable hitSlop={10} style={[styles.catIconCircle, { transform: [] }]} onPress={() => router.push("/musica-info" as never)}>
              <Image source={require("@/assets/images/cat-musica.png")} style={{ width: 18, height: 18 }} contentFit="contain" tintColor="#f9f9f9" />
            </Pressable>
          </View>
        </View>
      ...
      <Animated.View style={[styles.stickyHeader, { paddingTop: topPad + 8, opacity: stickyHeaderOpacity, backgroundColor: theme.gradient[0] }]} pointerEvents={stickyActive ? "auto" : "none"}>
        <View style={styles.stickyHeaderRow}>
          ...
          <View style={styles.headerTitleCol}>
            <Text style={[styles.headerTitle, { fontWeight: "600", transform: [{ translateY: -4 }] }]}>Música</Text>
          </View>
          <View style={{ width: 40 }} />
        </View>
        <View style={[styles.heroOverlayLeft, { top: topPad - 17 }]}>
...
const styles = StyleSheet.create({
  ...
  chip: { height: 32, paddingHorizontal: 13, borderRadius: 999, overflow: "hidden", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.053)", borderWidth: 1, borderColor: "rgba(247,203,107,0.1)" },
  chipBorder: {},
  chipBorderSel: {},
  chipUnsel: {},
  chipSel: { borderWidth: 0 },
  chipText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "450", letterSpacing: 0.3, color: TEXT, textAlign: "center" },
