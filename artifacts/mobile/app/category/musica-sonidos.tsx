        ...
        <View style={styles.heroArea}>
          ...
          <View style={styles.heroIconFloat}>
            <View style={styles.heroIconGlow}>
              <MaskedView maskElement={<View style={{ width: 36, height: 36, alignItems: "center", justifyContent: "center" }}><Ionicons name="musical-notes-outline" size={36} color="#fff" /></View>}>
