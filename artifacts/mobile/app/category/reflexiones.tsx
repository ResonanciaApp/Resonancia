  ...
  return (
    <Modal visible={visible} animationType="fade" transparent onRequestClose={onClose} onShow={()=>inputRef.current?.focus()}>
      <View style={[styles.searchModalRoot,{paddingBottom:kbH}]}>
        ...
        {results.length>0&&(
          <ScrollView style={{flex:1,backgroundColor:"#16040A"}} contentContainerStyle={{padding:H_PAD,gap:9}} keyboardShouldPersistTaps="handled">
...
const styles = StyleSheet.create({
  ...
  sortSheet: { position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: "#16040A", borderTopLeftRadius: 22, borderTopRightRadius: 22, paddingTop: 10, paddingHorizontal: 20 },
  ...
  qsSheet: { position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: "#16040A", borderTopLeftRadius: 22, borderTopRightRadius: 22, paddingTop: 10, paddingHorizontal: 20, borderTopWidth: StyleSheet.hairlineWidth, borderColor: "#3D0E16" },
  ...
  searchModalRoot: { flex: 1, backgroundColor: "#16040A" },
  searchOverlay: { flexDirection: "row", alignItems: "center", backgroundColor: "#16040A", paddingTop: Platform.OS === "ios" ? 56 : 36, paddingHorizontal: H_PAD, paddingBottom: 14, gap: 10 },
  ...
  searchEmpty: { flex: 1, backgroundColor: "#16040A", alignItems: "center", justifyContent: "center", paddingHorizontal: 32 },
