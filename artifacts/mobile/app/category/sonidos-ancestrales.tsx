...
const styles = StyleSheet.create({
  ...
  heroIconFloat: { position: "absolute", bottom: -3, left: 0, right: 0, alignItems: "center", zIndex: 2 },
  ...
  /* ── Profile card ── */
  profileCard: { marginHorizontal: H_PAD, marginTop: 17, paddingBottom: 14, gap: 8, alignItems: "center" },
