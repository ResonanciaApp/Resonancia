...
const styles = StyleSheet.create({
  ...
  chip: { height: 32, paddingHorizontal: 14, borderRadius: 999, overflow: "hidden", alignItems: "center", justifyContent: "center", backgroundColor: "#221A3D", borderWidth: 1.5, borderColor: "rgba(244,244,244,0.30)" },
  chipBorder: {},
  chipBorderSel: {},
  chipUnsel: {},
  chipSel: { borderWidth: 0 },
  chipText: { fontFamily: "Manrope", fontSize: 15, fontWeight: "700", color: TEXT, textAlign: "center" },
