...
const styles = StyleSheet.create({
  ...
  /* ── Tabs (chips) ── */
  chipsArea: { paddingTop: 10, paddingBottom: 0, overflow: "visible", marginTop: -8, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "rgba(212,175,55,0.15)" },
