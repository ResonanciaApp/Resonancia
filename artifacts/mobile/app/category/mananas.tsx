...
const SUBCATEGORIES: SubDef[] = [
  { tag: "Meditación",   icon: "meditation",    family: "MaterialCommunityIcons", description: "Calma y presencia para abrir el día" },
  { tag: "Respiración",  icon: "wind",          family: "Feather",                description: "Respira y oxigena cuerpo y mente" },
  { tag: "Afirmaciones", icon: "message-circle", family: "Feather",               description: "Palabras que siembran tu día" },
  { tag: "Gratitud",     icon: "heart",         family: "Feather",                description: "Agradece y eleva tu energía" },
  { tag: "Optimismo",    icon: "sun",           family: "Feather",                description: "Una mirada luminosa hacia adelante" },
];
          ...
          <View style={{ paddingHorizontal: H_PAD }}>
            {filteredSessions.length === 0 ? (
              <View style={styles.emptyWrap}>
                <Feather name="sunrise" size={40} color={colors.mutedForeground} style={{ marginBottom: 12 }} />
