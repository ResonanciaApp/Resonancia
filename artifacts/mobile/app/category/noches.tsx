...
const styles = StyleSheet.create({
  ...
  chip: { height: 31, paddingHorizontal: 14, borderRadius: 999, overflow: "hidden", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,0.28)", borderWidth: 1, borderColor: "rgba(255,255,255,0.2)" },
  chipTibet: { backgroundColor: "rgba(0,0,0,0.1)" },
  chipIndigo: { backgroundColor: "rgba(181,211,255,0.1)" },
  chipIndigo2Inactive: { backgroundColor: "rgba(0,0,0,0.2)", borderColor: "rgba(255,255,255,0.2)" },
