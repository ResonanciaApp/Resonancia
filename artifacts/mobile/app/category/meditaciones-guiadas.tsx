...
const styles = StyleSheet.create({
  ...
  stickyHeader: { position: "absolute", top: 0, left: 0, right: 0, zIndex: 20, minHeight: 48, paddingHorizontal: H_PAD, paddingBottom: 4, alignItems: "center", justifyContent: "center" },
