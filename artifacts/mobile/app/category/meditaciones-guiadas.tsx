    ...
    return (
      <>
        ...
        {activeTab === null && (
          ...
          >
            <Text style={{ fontFamily: "Manrope", fontSize: 15, fontWeight: "600", color: "#F7CB6B" }}>Todas las Meditaciones</Text>
      ...
      >
        ...
        <View style={[styles.heroArea, { height: topPad + 48 }]}>
          ...
          <View style={[styles.heroOverlayRight, { top: topPad - 18 }]}>
            <Pressable hitSlop={10} style={[styles.catIconCircle, { transform: [] }]} onPress={() => router.push("/meditaciones-info" as never)}>
