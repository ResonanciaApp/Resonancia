...
function applySort(arr: ReturnType<typeof getSessionsForTab>, sort: SortMode, playCounts: Record<string,number> = {}) {
  if (sort === "nuevas")    return [...arr].sort((a,b) => {
    ...
    if (!aIsNum && bIsNum)  return -1; // usr_* (admin) va primero
    if (aIsNum  && !bIsNum) return  1;
    if (!aIsNum && !bIsNum) {
      // Ambas son del admin: ordenar por createdAt DESC (más reciente primero)
...
const ac = StyleSheet.create({
  ...
  hDuration:{fontSize:12,fontFamily:"Jost",fontWeight:"500",color:"rgba(255,255,255,0.8)"},
  hDurLabel:{position:"absolute",bottom:6,left:8,fontSize:13,fontFamily:"OptimaBold",color:"#fff",textShadowColor:"rgba(0,0,0,0.85)",textShadowOffset:{width:0,height:1},textShadowRadius:4},
  hTitle:{fontSize:14,fontFamily:"Jost",fontWeight:"600",color:TEXT,lineHeight:21},
  hAuthor:{fontSize:14,fontFamily:"Jost",color:MUTED,flex:1},
  ...
  cardTitle:{fontSize:14,fontFamily:"Jost",fontWeight:"600",color:TEXT,lineHeight:21},
  cardAuthor:{fontSize:14,fontFamily:"Jost",color:MUTED},
  ...
  durationBadgeText:{fontSize:11,fontFamily:"Jost",fontWeight:"600",color:"#fff"},
...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 28, fontFamily: "OptimaBold", color: "#fff", letterSpacing: 0.2, textAlign: "center" },
