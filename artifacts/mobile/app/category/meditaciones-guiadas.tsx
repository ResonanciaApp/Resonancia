...
const ac = StyleSheet.create({
  ...
  hTitle:{fontSize:15,fontFamily:"Jost",fontWeight:"600",color:TEXT,lineHeight:21},
  ...
  cardTitle:{fontSize:15,fontFamily:"Jost",fontWeight:"600",color:TEXT,lineHeight:21},
