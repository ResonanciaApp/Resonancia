...
const styles = StyleSheet.create({
  ...
  recTime: { fontSize: 13, fontFamily: "Jost", fontWeight: "600" },
  audioBubble: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  audioTime: { fontSize: 11, fontFamily: "Jost", marginTop: 4 },
  ...
  attachTitle: { fontSize: 18, fontFamily: "OptimaBold", marginBottom: 6 },
  attachOption: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
  ...
  attachLabel: { fontSize: 14, fontFamily: "Jost", fontWeight: "700", marginBottom: 2 },
  attachSub: { fontSize: 12, fontFamily: "Jost" },
  header: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  headerInitials: { fontSize: 13, fontFamily: "OptimaBold" },
  headerName: { fontSize: 15, fontFamily: "OptimaBold" },
  headerSub: { fontSize: 12, fontFamily: "Jost", marginTop: 2 },
  empty: { fontSize: 13, fontFamily: "Jost", textAlign: "center", paddingHorizontal: 32 },
  emptyWrap: { flex: 1, alignItems: "center", justifyContent: "center" },
  timeLabel: { fontSize: 10, fontFamily: "Jost", marginTop: 12, marginBottom: 4, alignSelf: "center" },
  bubble: {
    maxWidth: "78%",
    borderRadius: 18,
    paddingHorizontal: 14,
  ...
  bubbleText: { fontSize: 14, fontFamily: "Jost", lineHeight: 19 },
  readReceipt: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 2 },
  readText: { fontSize: 10, fontFamily: "Jost" },
  sessionCard: {
    flexDirection: "row",
    width: 240,
    borderRadius: 14,
  ...
  sessionLabel: { fontSize: 9, fontFamily: "OptimaBold", letterSpacing: 0.8, marginBottom: 2 },
  sessionTitle: { fontSize: 13, fontFamily: "OptimaBold", marginBottom: 2 },
  sessionDuration: { fontSize: 11, fontFamily: "Jost" },
  inputBar: {
    flexDirection: "row",
    alignItems: "flex-end",
    gap: 8,
  ...
  searchInput: { flex: 1, fontFamily: "Jost", fontSize: 14 },
  pickerRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  pickerLabel: { fontSize: 9, fontFamily: "OptimaBold", letterSpacing: 0.8, marginBottom: 2 },
  pickerTitle: { fontSize: 13, fontFamily: "OptimaBold" },
  pickerRoot: { flex: 1 },
  pickerHeader: {
    flexDirection: "row",
    alignItems: "center",
  ...
  pickerHeaderTitle: { fontSize: 16, fontFamily: "OptimaBold" },
  searchBox: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
