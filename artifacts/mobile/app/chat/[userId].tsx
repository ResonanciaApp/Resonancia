          ...
          {recording ? (
            <>
              ...
              <Pressable onPress={sendRecording} style={styles.sendBtn}>
                <LinearGradient colors={["#FFFFFF", "#C1AA8A"]} style={styles.sendGrad}>
      ...
      {isImage ? (
        ...
        <Pressable
          ...
          style={[
            styles.sessionCard,
            {
              backgroundColor: isMine ? "#C1AA8A" : colors.card,
      ...
      {isMine && isLastMine && (
        <View style={styles.readReceipt}>
          <Feather
            ...
            size={11}
            color={message.readAt ? "#C1AA8A" : colors.mutedForeground}
          />
      ...
      <View style={{ position: "relative", opacity: item.failed ? 0.55 : 0.85 }}>
        {item.kind === "image" ? (
          ...
          <View
            style={[
              styles.audioBubble,
              { backgroundColor: "#C1AA8A", borderWidth: 0 },
            ]}
          >
...
function AudioAttachment({
  ...
  const bg = isMine ? "#C1AA8A" : colors.card;
