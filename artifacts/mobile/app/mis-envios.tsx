...
> = {
  draft: { label: "Borrador", icon: "edit-3", color: "rgba(232,232,232,0.45)" },
...
const styles = StyleSheet.create({
  ...
  reasonLabel: { fontSize: 11, fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.4 },
  reasonText: { fontSize: 13, lineHeight: 19, marginTop: 4 },
