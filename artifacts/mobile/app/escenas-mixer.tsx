          ...
          <View style={styles.controlsCard}>
            ...
            <View style={[styles.controlRow, { opacity: 0.45 }]}>
              ...
              <Switch
                ...
                disabled
                trackColor={{ false: "#CCC", true: "#F9F9F9" }}
                thumbColor="#FFF"
              />
            </View>
            ...
            <View style={[styles.previewBottom, { paddingBottom: insets.bottom + 24 }]}>
              ...
              >
                {selectedId === previewScene.id && (
                  <Feather name="check" size={17} color="#F9F9F9" style={{ marginRight: 6 }} />
                )}
                <Text style={[
                  styles.applyBtnText,
...
const styles = StyleSheet.create({
  ...
  cardLabelActive: { fontFamily: "Manrope", color: "#F9F9F9", fontWeight: "700" },
  ...
  applyBtnTextActive: { color: "#F9F9F9" },
});
