      ...
      >
        ...
        {entries.length === 0 ? (
          <View style={[styles.empty, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <Feather name="clock" size={26} color={"rgba(212,175,55,0.4)"} />
...
const styles = StyleSheet.create({
  ...
  countLabel: { fontFamily: "Manrope", fontSize: 12, marginBottom: 12 },
  row: { marginBottom: 6 },
  timeLabel: { fontFamily: "Manrope", fontSize: 11, marginBottom: 4, marginLeft: 4, letterSpacing: 0.4 },
  empty: {
    borderRadius: 18, borderWidth: 1, padding: 24, alignItems: "center", gap: 10,
  },
  emptyTitle: { fontFamily: "Manrope", fontSize: 15, fontWeight: "700" },
  emptyText: { fontFamily: "Manrope", fontSize: 13, lineHeight: 19, textAlign: "center" },
  emptyLink: {
    marginTop: 6, borderWidth: 1, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 8,
  },
  emptyLinkText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600" },
});
