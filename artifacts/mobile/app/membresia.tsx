...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontFamily: "Manrope", fontSize: 34, fontWeight: "700", textAlign: "center", lineHeight: 42, marginBottom: 14 },
  divider: { width: 160, height: 1, marginBottom: 14 },
  heroSub: { fontFamily: "Manrope", fontSize: 14, textAlign: "center" },
  ...
  bestText: { fontFamily: "Manrope", color: "#08150F", fontSize: 9, fontWeight: "800", letterSpacing: 1 },
  planName: { fontFamily: "Manrope", fontSize: 18, fontWeight: "700", marginTop: 8 },
  priceRow: { flexDirection: "row", alignItems: "flex-end", gap: 2 },
  price: { fontFamily: "Manrope", fontSize: 30, fontWeight: "700", lineHeight: 34 },
  pricePer: { fontFamily: "Manrope", fontSize: 13, marginBottom: 5 },
  planSub: { fontFamily: "Manrope", fontSize: 11, fontWeight: "500" },
  saveBadge: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3, alignSelf: "flex-start", marginTop: 4 },
  saveText: { fontFamily: "Manrope", fontSize: 11, fontWeight: "700" },
  benefitsBlock: { marginBottom: 28 },
  benefitsTitle: { fontFamily: "Manrope", fontSize: 16, fontWeight: "700", marginBottom: 16 },
  ...
  benefitText: { fontFamily: "Manrope", flex: 1, fontSize: 14, lineHeight: 20 },
  ...
  ctaText: { fontFamily: "Manrope", color: "#08150F", fontWeight: "800", fontSize: 16, letterSpacing: 0.3 },
  restoreBtn: { alignItems: "center", paddingVertical: 6, marginBottom: 10 },
  restoreText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600", textDecorationLine: "underline" },
  feedback: { fontFamily: "Manrope", fontSize: 12.5, textAlign: "center", lineHeight: 18, marginBottom: 12 },
  legal: { fontFamily: "Manrope", fontSize: 11, textAlign: "center", lineHeight: 16 },
  ...
  activeTitle: { fontFamily: "Manrope", fontSize: 24, fontWeight: "800", marginBottom: 10 },
  activeSub: { fontFamily: "Manrope", fontSize: 13.5, textAlign: "center", lineHeight: 20 },
  // Modal
  ...
  modalTitle: { fontFamily: "Manrope", fontSize: 18, fontWeight: "700", marginBottom: 8, textAlign: "center" },
  modalBody: { fontFamily: "Manrope", fontSize: 14, textAlign: "center", marginBottom: 20, lineHeight: 20 },
  ...
  modalBtnGhostText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
  modalBtnPrimary: { flex: 1, borderRadius: 50, overflow: "hidden" },
  modalBtnPrimaryGrad: { paddingVertical: 14, alignItems: "center" },
  modalBtnPrimaryText: { fontFamily: "Manrope", color: "#08150F", fontWeight: "800", fontSize: 14 },
});
