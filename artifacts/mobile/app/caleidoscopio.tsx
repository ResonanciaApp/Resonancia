...
const THEMES = [
  { name: "Dorado",  fill: ["#BE8744","#E9C46A","#FAF0EE","#C49F27","#BE8744"], stroke: "#FAF0EE", glow: "#BE8744" },
        ...
        <>
          ...
          <View style={[styles.bottomPanel, { paddingBottom: insets.bottom + 12 }]}>
              ...
              {PATTERNS.map((p, i) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.75}
                  >
                    <Feather name={p.icon} size={16} color={on ? "#BE8744" : "rgba(194,194,194,0.45)"} />
            ...
            <TouchableOpacity style={styles.saveBtn} onPress={() => {}} activeOpacity={0.8}>
              <Feather name="download" size={15} color="#BE8744" />
...
const styles = StyleSheet.create({
  ...
  topSub:           { color: "rgba(194,194,194,0.45)", fontSize: 11, marginTop: 1 },
  ...
  sectionLabel:     { color: "rgba(194,194,194,0.45)", fontSize: 10, fontWeight: "600", letterSpacing: 1, textTransform: "uppercase", marginBottom: 7 },
  ...
  patternBtnText:   { color: "rgba(194,194,194,0.45)", fontSize: 12 },
  ...
  segBtnText:       { color: "rgba(194,194,194,0.45)", fontSize: 13 },
  ...
  speedVal:         { color: "#BE8744", fontSize: 10 },
  ...
  saveBtnText:      { color: "#BE8744", fontSize: 13, fontWeight: "600" },
