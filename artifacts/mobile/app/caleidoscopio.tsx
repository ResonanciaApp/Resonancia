...
const styles = StyleSheet.create({
  ...
  topSub:           { color: "#c2c2c2", fontSize: 11, marginTop: 1 },
  ...
  sectionLabel:     { color: "#c2c2c2", fontSize: 10, fontWeight: "600", letterSpacing: 1, textTransform: "uppercase", marginBottom: 7 },
  ...
  patternBtnText:   { color: "#c2c2c2", fontSize: 12 },
  patternBtnTextOn: { color: "#F7CB6B", fontWeight: "600" },
  ...
  segBtnText:       { color: "#c2c2c2", fontSize: 13 },
  segBtnTextOn:     { color: "#F7CB6B", fontWeight: "700" },
  ...
  speedVal:         { color: "#F7CB6B", fontSize: 10 },
  ...
  saveBtnText:      { color: "#F7CB6B", fontSize: 13, fontWeight: "600" },
