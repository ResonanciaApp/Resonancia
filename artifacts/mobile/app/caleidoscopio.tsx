...
const THEMES = [
  { name: "Dorado",  fill: ["#F7CB6B","#FBA980","#FAF0EE","#C49F27","#F7CB6B"], stroke: "#FAF0EE", glow: "#F7CB6B" },
        ...
        <>
          ...
          <View style={[styles.bottomPanel, { paddingBottom: insets.bottom + 12 }]}>
              ...
              {PATTERNS.map((p, i) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.75}
                  >
                    <Feather name={p.icon} size={16} color={on ? "#F7CB6B" : "#c2c2c2"} />
            ...
            <TouchableOpacity style={styles.saveBtn} onPress={() => {}} activeOpacity={0.8}>
              <Feather name="download" size={15} color="#F7CB6B" />
...
const styles = StyleSheet.create({
  ...
  topTitle:         { fontFamily: "Manrope", color: "#FAF0EE", fontSize: 15, fontWeight: "600", letterSpacing: 0.3 },
  topSub:           { fontFamily: "Manrope", color: "#c2c2c2", fontSize: 11, marginTop: 1 },
  ...
  sectionLabel:     { fontFamily: "Manrope", color: "#c2c2c2", fontSize: 10, fontWeight: "600", letterSpacing: 1, textTransform: "uppercase", marginBottom: 7 },
  ...
  patternBtnTextOn: { fontFamily: "Manrope", color: "#F7CB6B", fontWeight: "600" },
  ...
  segBtnTextOn:     { fontFamily: "Manrope", color: "#F7CB6B", fontWeight: "700" },
  ...
  speedVal:         { fontFamily: "Manrope", color: "#F7CB6B", fontSize: 10 },
  ...
  saveBtnText:      { fontFamily: "Manrope", color: "#F7CB6B", fontSize: 13, fontWeight: "600" },
