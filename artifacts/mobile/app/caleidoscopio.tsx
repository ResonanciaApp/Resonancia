...
const THEMES = [
  { name: "Dorado",  fill: ["#D4AF37","#E9C46A","#FAF0EE","#C49F27","#D4AF37"], stroke: "#FAF0EE", glow: "#D4AF37" },
        ...
        <>
          ...
          <View style={[styles.topBar, { paddingTop: insets.top + 8 }]}>
            ...
            <Pressable onPress={() => setPaused((v) => !v)} hitSlop={12} style={styles.iconBtn} accessibilityRole="button">
              <Feather name={paused ? "play" : "pause"} size={18} color="#FAF0EE" />
            </Pressable>
          </View>
              ...
              {PATTERNS.map((p, i) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.75}
                  >
                    <Feather name={p.icon} size={16} color={on ? "#D4AF37" : "rgba(250,240,238,0.45)"} />
...
const styles = StyleSheet.create({
  ...
  topTitle:         { color: "#FAF0EE", fontSize: 15, fontFamily: "OptimaBold", letterSpacing: 0.3 },
  topSub:           { color: "rgba(250,240,238,0.45)", fontSize: 11, fontFamily: "Jost", marginTop: 1 },
  ...
  sectionLabel:     { color: "rgba(250,240,238,0.45)", fontSize: 10, fontFamily: "Jost", fontWeight: "600", letterSpacing: 1, textTransform: "uppercase", marginBottom: 7 },
  ...
  patternBtnText:   { color: "rgba(250,240,238,0.45)", fontSize: 12, fontFamily: "Jost" },
  patternBtnTextOn: { color: "#D4AF37", fontWeight: "600", fontFamily: "Jost" },
  ...
  segBtnText:       { color: "rgba(250,240,238,0.45)", fontSize: 13, fontFamily: "Jost" },
  segBtnTextOn:     { color: "#D4AF37", fontFamily: "OptimaBold" },
  ...
  speedVal:         { color: "#D4AF37", fontSize: 10, fontFamily: "Jost" },
  ...
  saveBtnText:      { color: "#D4AF37", fontSize: 13, fontFamily: "Jost", fontWeight: "600" },
  tapHint:          { position: "absolute", alignSelf: "center", zIndex: 10 },
  tapHintText:      { color: "rgba(237,225,211,0.3)", fontSize: 11, fontFamily: "Jost", letterSpacing: 0.5 },
});
