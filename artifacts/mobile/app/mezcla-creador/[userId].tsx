...
const styles = StyleSheet.create({
  ...
  avatarTxt: { fontSize: 34, fontFamily: "Jost", fontWeight: "700" },
  name: { fontSize: 22, fontFamily: "OptimaBold", letterSpacing: 0.3, marginTop: 6 },
  stats: { fontSize: 14, fontFamily: "Jost" },
  empty: { alignItems: "center", gap: 10, marginTop: 48, paddingHorizontal: 20 },
  emptyText: { fontSize: 14, fontFamily: "Jost", textAlign: "center", lineHeight: 20 },
  list: { gap: 10 },
  sectionTitle: { fontSize: 17, fontFamily: "OptimaBold", letterSpacing: 0.3, marginBottom: 4 },
  mixRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
  ...
  mixName: { fontSize: 15, fontFamily: "Jost", fontWeight: "700" },
  mixMeta: { fontSize: 12, fontFamily: "Jost", marginTop: 3 },
});
