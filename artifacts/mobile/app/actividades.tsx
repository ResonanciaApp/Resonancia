...
const styles = StyleSheet.create({
  ...
  filterText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600" },
  list: { gap: 14 },
  card: {
    borderRadius: 18,
    borderWidth: 1,
  ...
  cardTitle: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700", lineHeight: 19 },
  cardOrg: { fontFamily: "Manrope", fontSize: 11, fontWeight: "600" },
  cardMeta: { flexDirection: "row", alignItems: "center", gap: 4, flexWrap: "wrap" },
  cardMetaText: { fontFamily: "Manrope", fontSize: 11 },
  ...
  typeBadgeText: { fontFamily: "Manrope", fontSize: 10, fontWeight: "700" },
  attendeesRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  attendeesText: { fontFamily: "Manrope", fontSize: 11 },
  fab: {
    position: "absolute",
    right: 20,
    width: 56,
