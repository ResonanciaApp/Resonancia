...
export default function ActividadesScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        <LinearGradient colors={["#4A0C0C", "#27070E", "#1B060F"]} style={styles.fabGrad}>
...
const styles = StyleSheet.create({
  ...
  filterText: { fontSize: 13, fontFamily: "Jost", fontWeight: "600" },
  list: { gap: 14 },
  card: {
    borderRadius: 18,
    borderWidth: 1,
  ...
  cardTitle: { fontSize: 14, fontFamily: "OptimaBold", lineHeight: 19 },
  cardOrg: { fontSize: 11, fontFamily: "Jost", fontWeight: "600" },
  cardMeta: { flexDirection: "row", alignItems: "center", gap: 4, flexWrap: "wrap" },
  cardMetaText: { fontSize: 11, fontFamily: "Jost" },
  ...
  typeBadgeText: { fontSize: 10, fontFamily: "OptimaBold" },
  attendeesRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  attendeesText: { fontSize: 11, fontFamily: "Jost" },
  fab: {
    position: "absolute",
    right: 20,
    width: 56,
