  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.headerRow, { paddingHorizontal: H_PAD, paddingTop: topPad + 8 }]}>
        ...
        >
          <Feather name="user" size={13} color="#F9F9F9" />
          ...
          <View style={[styles.section, { paddingHorizontal: H_PAD }]}>
            ...
            <View style={styles.linksRow}>
              {expansor.links.map((link) => (
                ...
                >
                  <Feather name="external-link" size={13} color="#F9F9F9" />
...
const styles = StyleSheet.create({
  ...
  verPerfilText: { fontFamily: "Manrope", fontSize: 13, color: "#F9F9F9", fontWeight: "600" },
  backBtn: {
    width: 38,
    height: 38,
    borderRadius: 19,
  ...
  certLabel: { fontFamily: "Manrope", fontSize: 12, color: "#F9F9F9", fontWeight: "600" },
  ...
  linkLabel: { fontFamily: "Manrope", fontSize: 13, color: "#F9F9F9", fontWeight: "600" },
  ...
  certCardStar: { fontFamily: "Manrope", fontSize: 20, color: "#F9F9F9", marginTop: 2 },
  certCardTitle: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700", color: "#F9F9F9", marginBottom: 4 },
