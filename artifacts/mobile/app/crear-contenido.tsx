...
const styles = StyleSheet.create({
  ...
  assetText: { fontSize: 14, fontFamily: "Jost" },
  ...
  switchTitle: { fontSize: 14, fontFamily: "Jost", fontWeight: "600" },
  switchDesc: { fontSize: 12, fontFamily: "Jost", marginTop: 2 },
  ...
  hint: { fontSize: 12, fontFamily: "Jost", textAlign: "center", lineHeight: 18, marginTop: 14 },
  gate: { alignItems: "center", paddingHorizontal: 32, gap: 14 },
  gateTitle: { fontSize: 18, fontFamily: "OptimaBold" },
  gateText: { fontSize: 14, fontFamily: "Jost", textAlign: "center", lineHeight: 21 },
  gateBtn: { borderWidth: 1, borderRadius: 14, paddingVertical: 12, paddingHorizontal: 28, marginTop: 8 },
  gateBtnText: { fontSize: 14, fontFamily: "OptimaBold" },
});
