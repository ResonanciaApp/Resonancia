...
const SEED_GRUPOS: Record<string, {
  ...
  "g1": {
    ...
    memberList: [
      { name: "Sofía Herrera", role: "Moderadora", color: "#f7ca8e", initials: "SH", active: true },
    ...
    posts: [
      { id: "p1", author: "Sofía Herrera", initials: "SH", color: "#f7ca8e", time: "Hoy · 09:15", text: "📌 Recordatorio: esta semana comenzamos el ciclo de 10 días de práctica en silencio. Pueden compartir su experiencia aquí cada noche. ¿Quiénes se suman?", likes: 18, replies: 7, pinned: true },
  ...
  "g2": {
    ...
    memberList: [
      ...
      { name: "Sofía Herrera", role: "Miembro", color: "#f7ca8e", initials: "SH", active: true },
    ...
    posts: [
      ...
      { id: "p5", author: "Sofía Herrera", initials: "SH", color: "#f7ca8e", time: "Lunes · 12:00", text: "Para los que están empezando: este es el orden de notas que uso en mis baños de cuencos. DO → RE → MI → FA → SOL → LA → SI. Cada nota corresponde a un chakra. 🙏", likes: 52, replies: 18 },
    ],
  },
  "g3": {
    name: "Sueños Lúcidos",
    ...
    memberList: [
      ...
      { name: "Sofía Herrera", role: "Miembro", color: "#f7ca8e", initials: "SH", active: false },
    ...
    posts: [
      ...
      { id: "p3", author: "Sofía Herrera", initials: "SH", color: "#f7ca8e", time: "Ayer · 23:30", text: "Sueño de anoche: estaba en un templo en las nubes. Un anciano me entregó un cuenco de oro y dijo 'el sonido que buscas viene de adentro'. Al despertar me quedó una paz enorme.", likes: 22, replies: 5 },
    ],
  },
  "g4": {
