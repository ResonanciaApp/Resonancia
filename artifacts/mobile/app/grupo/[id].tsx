...
const SEED_GRUPOS: Record<string, {
  ...
  "g1": {
    ...
    memberList: [
      { name: "Sofía Herrera", role: "Moderadora", color: "#f4c993", initials: "SH", active: true },
    ...
    posts: [
      { id: "p1", author: "Sofía Herrera", initials: "SH", color: "#f4c993", time: "Hoy · 09:15", text: "📌 Recordatorio: esta semana comenzamos el ciclo de 10 días de práctica en silencio. Pueden compartir su experiencia aquí cada noche. ¿Quiénes se suman?", likes: 18, replies: 7, pinned: true },
  ...
  "g2": {
    ...
    memberList: [
      { name: "Casa del Cuenco", role: "Moderador", color: "#F9F9F9", initials: "CC", active: true },
    ...
    posts: [
      { id: "p1", author: "Casa del Cuenco", initials: "CC", color: "#F9F9F9", time: "Hoy · 11:00", text: "📌 Nueva sesión disponible en la app: 'El Lago de Cristal' — cuencos de cuarzo en sol mayor para la claridad mental. ¡A escucharla y compartir qué sienten! 🎶", likes: 41, replies: 12, pinned: true },
      ...
      { id: "p5", author: "Sofía Herrera", initials: "SH", color: "#f4c993", time: "Lunes · 12:00", text: "Para los que están empezando: este es el orden de notas que uso en mis baños de cuencos. DO → RE → MI → FA → SOL → LA → SI. Cada nota corresponde a un chakra. 🙏", likes: 52, replies: 18 },
    ],
  },
  "g3": {
    name: "Sueños Lúcidos",
    ...
    memberList: [
      ...
      { name: "Sofía Herrera", role: "Miembro", color: "#f4c993", initials: "SH", active: false },
    ...
    posts: [
      ...
      { id: "p3", author: "Sofía Herrera", initials: "SH", color: "#f4c993", time: "Ayer · 23:30", text: "Sueño de anoche: estaba en un templo en las nubes. Un anciano me entregó un cuenco de oro y dijo 'el sonido que buscas viene de adentro'. Al despertar me quedó una paz enorme.", likes: 22, replies: 5 },
    ],
  },
  "g4": {
...
const styles = StyleSheet.create({
  ...
  groupName: { fontFamily: "Manrope", color: "#FFFFFF", fontSize: 18, fontWeight: "700", marginBottom: 3 },
  groupSub: { fontFamily: "Manrope", color: "#F4F4F4", fontSize: 12, marginBottom: 6 },
  groupMeta: { flexDirection: "row", alignItems: "center", gap: 5 },
  groupMetaText: { fontFamily: "Manrope", color: "#F4F4F4", fontSize: 11 },
  groupMetaDot: { fontFamily: "Manrope", color: "#F4F4F4", fontSize: 11 },
  ...
  tabText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
  // Posts
  ...
  pinnedText: { fontFamily: "Manrope", fontSize: 11, fontWeight: "600" },
  ...
  postInitials: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700" },
  postAuthor: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700" },
  postTime: { fontFamily: "Manrope", fontSize: 11 },
  postText: { fontFamily: "Manrope", fontSize: 14, lineHeight: 22 },
  postActions: { flexDirection: "row", gap: 20, paddingTop: 10, borderTopWidth: 1 },
  actionBtn: { flexDirection: "row", alignItems: "center", gap: 5 },
  actionText: { fontFamily: "Manrope", fontSize: 13 },
  // Empty state
  emptyState: { borderRadius: 16, borderWidth: 1, borderStyle: "dashed", padding: 24, alignItems: "center", gap: 8 },
  emptyTitle: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700", marginTop: 4 },
  emptySub: { fontFamily: "Manrope", fontSize: 12, textAlign: "center", lineHeight: 18 },
  // Compose
  ...
  // Members
  memberCount: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600", marginBottom: 12, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  memberInitials: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700" },
  ...
  memberName: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
  memberRole: { fontFamily: "Manrope", fontSize: 12, marginTop: 2 },
  // Info
  ...
  infoCardTitle: { fontFamily: "Manrope", fontSize: 15, fontWeight: "700" },
  infoCardText: { fontFamily: "Manrope", fontSize: 14, lineHeight: 21 },
  ...
  modInitials: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700" },
  modName: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
  ruleRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  ruleNum: { width: 26, height: 26, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  ruleNumText: { fontFamily: "Manrope", fontSize: 12, fontWeight: "700" },
  ruleText: { fontFamily: "Manrope", fontSize: 13, flex: 1, lineHeight: 19 },
  badgeRow: { flexDirection: "row", gap: 8 },
  badge: { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  badgeText: { fontFamily: "Manrope", fontSize: 11, fontWeight: "700", letterSpacing: 0.5 },
  ...
  leaveText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700" },
});
