...
const styles = StyleSheet.create({
  ...
  groupName: { color: "#FFFFFF", fontSize: 18, fontFamily: "OptimaBold", marginBottom: 3 },
  groupSub: { color: "rgba(244,218,213,0.55)", fontSize: 12, fontFamily: "Jost", marginBottom: 6 },
  groupMeta: { flexDirection: "row", alignItems: "center", gap: 5 },
  groupMetaText: { color: "rgba(244,218,213,0.55)", fontSize: 11, fontFamily: "Jost" },
  groupMetaDot: { color: "rgba(244,218,213,0.55)", fontSize: 11, fontFamily: "Jost" },
  ...
  tabText: { fontSize: 14, fontFamily: "OptimaBold" },
  // Posts
  ...
  pinnedText: { fontSize: 11, fontFamily: "OptimaBold" },
  ...
  postInitials: { fontSize: 13, fontWeight: "700", fontFamily: "Jost" },
  postAuthor: { fontSize: 14, fontFamily: "OptimaBold" },
  postTime: { fontSize: 11, fontFamily: "Jost" },
  postText: { fontSize: 14, lineHeight: 22, fontFamily: "Jost" },
  postActions: { flexDirection: "row", gap: 20, paddingTop: 10, borderTopWidth: 1 },
  actionBtn: { flexDirection: "row", alignItems: "center", gap: 5 },
  actionText: { fontSize: 13, fontFamily: "Jost" },
  // Empty state
  emptyState: { borderRadius: 16, borderWidth: 1, borderStyle: "dashed", padding: 24, alignItems: "center", gap: 8 },
  emptyTitle: { fontSize: 14, fontFamily: "OptimaBold", marginTop: 4 },
  emptySub: { fontSize: 12, textAlign: "center", lineHeight: 18, fontFamily: "Jost" },
  // Compose
  ...
  composeText: { fontSize: 14, fontFamily: "Jost" },
  sendBtn: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", borderWidth: 1 },
  // Members
  memberCount: { fontSize: 12, fontFamily: "OptimaBold", marginBottom: 12, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  memberName: { fontSize: 14, fontFamily: "OptimaBold" },
  memberRole: { fontSize: 12, marginTop: 2, fontFamily: "Jost" },
  // Info
  ...
  infoCardTitle: { fontSize: 15, fontFamily: "OptimaBold" },
  infoCardText: { fontSize: 14, lineHeight: 21, fontFamily: "Jost" },
  ...
  modInitials: { fontSize: 13, fontWeight: "700", fontFamily: "Jost" },
  modName: { fontSize: 14, fontFamily: "Jost", fontWeight: "600" },
  ruleRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  ruleNum: { width: 26, height: 26, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  ruleNumText: { fontSize: 12, fontWeight: "700", fontFamily: "Jost" },
  ruleText: { fontSize: 13, flex: 1, lineHeight: 19, fontFamily: "Jost" },
  badgeRow: { flexDirection: "row", gap: 8 },
  badge: { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  badgeText: { fontSize: 11, fontWeight: "700", fontFamily: "Jost", letterSpacing: 0.5 },
  linkBox: { borderRadius: 10, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 12 },
  linkText: { fontSize: 13, fontFamily: "Jost", fontWeight: "600" },
  ...
  leaveText: { fontSize: 14, fontFamily: "OptimaBold" },
});
