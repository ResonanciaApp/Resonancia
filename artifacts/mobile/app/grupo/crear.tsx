...
const preview = StyleSheet.create({
  root: { alignItems: "center", paddingTop: 32, paddingBottom: 16, backgroundColor: "#0F1A13" },
...
export default function CrearGrupoScreen() {
  ...
  if (step === 1) {
    return (
      <KeyboardAvoidingView
        style={[styles.root, { backgroundColor: "#0F1A13" }]}
      ...
      >
        ...
        <View style={[styles.stepFooter, { paddingBottom: bottomPad + 12 }]}>
          <Pressable
            ...
            disabled={!canNext1}
          >
            <Text style={[styles.nextBtnText, { color: canNext1 ? "#0F1A13" : colors.mutedForeground }]}>
              Terminar
            </Text>
          </Pressable>
        </View>
        ...
        <BottomSheet key={step} colors={colors}>
          ...
          {step === 2 && (
            <>
              ...
              >
                <Text style={[styles.sheetNextText, { color: "#0F1A13" }]}>Siguiente</Text>
              </Pressable>
            ...
            <>
              <View style={styles.successIcon}>
                <LinearGradient colors={["#C8C1B5", "#B6955F"]} style={styles.successGrad}>
                  <Feather name="check" size={28} color="#0F1A13" />
                </LinearGradient>
              </View>
              ...
              <Pressable onPress={handleShare} style={[styles.sheetNext, { backgroundColor: colors.primary, marginTop: 16 }]}>
                <Feather name="share-2" size={17} color="#0F1A13" />
                <Text style={[styles.sheetNextText, { color: "#0F1A13" }]}>Compartir enlace</Text>
              </Pressable>
