...
const preview = StyleSheet.create({
  root: { alignItems: "center", paddingTop: 32, paddingBottom: 16, backgroundColor: "#16040A" },
      ...
      >
        ...
        <View style={{ paddingTop: topPad + 12, paddingHorizontal: 20, flex: 1 }}>
          ...
          <View style={[styles.nameInputBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            />
            <Text style={[styles.nameCounter, { color: remaining < 10 ? "#BE8744" : colors.mutedForeground }]}>
              {remaining}
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  galleryItemSelected: { borderWidth: 2.5, borderColor: "#BE8744", borderRadius: 10 },
