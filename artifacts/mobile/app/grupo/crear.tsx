...
const preview = StyleSheet.create({
  root: { alignItems: "center", paddingTop: 32, paddingBottom: 16, backgroundColor: "#23332C" },
...
export default function CrearGrupoScreen() {
  ...
  if (step === 1) {
    return (
      <KeyboardAvoidingView
        style={[styles.root, { backgroundColor: "#23332C" }]}
      ...
      >
        ...
        <View style={{ paddingTop: topPad + 12, paddingHorizontal: 20, flex: 1 }}>
          ...
          <View style={[styles.nameInputBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            />
            <Text style={[styles.nameCounter, { color: remaining < 10 ? "#B6955F" : colors.mutedForeground }]}>
              {remaining}
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.stepFooter, { paddingBottom: bottomPad + 12 }]}>
          <Pressable
            ...
            disabled={!canNext1}
          >
            <Text style={[styles.nextBtnText, { color: canNext1 ? "#23332C" : colors.mutedForeground }]}>
              Terminar
            </Text>
          </Pressable>
        </View>
        ...
        <BottomSheet key={step} colors={colors}>
          ...
          {step === 2 && (
            <>
              ...
              >
                <Text style={[styles.sheetNextText, { color: "#23332C" }]}>Siguiente</Text>
              </Pressable>
            ...
            <>
              <View style={styles.successIcon}>
                <LinearGradient colors={["#C8C1B5", "#B6955F"]} style={styles.successGrad}>
                  <Feather name="check" size={28} color="#23332C" />
                </LinearGradient>
              </View>
              ...
              <Pressable onPress={handleShare} style={[styles.sheetNext, { backgroundColor: colors.primary, marginTop: 16 }]}>
                <Feather name="share-2" size={17} color="#23332C" />
                <Text style={[styles.sheetNextText, { color: "#23332C" }]}>Compartir enlace</Text>
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  galleryItemSelected: { borderWidth: 2.5, borderColor: "#B6955F", borderRadius: 10 },
  galleryImg: { width: 68, height: 68 },
  galleryCheck: { position: "absolute", bottom: 4, right: 4, backgroundColor: "#B6955F", borderRadius: 10, width: 20, height: 20, alignItems: "center", justifyContent: "center" },
