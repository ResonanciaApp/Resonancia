...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: "Manrope", flex: 1, fontSize: 14 },
  scroll: { paddingTop: 0 },
  heroGradient: { alignItems: "center", paddingTop: 12, paddingBottom: 20, paddingHorizontal: 24 },
  glyphContainer: { marginBottom: 12 },
  geoName: { fontFamily: "Manrope", fontSize: 24, fontWeight: "700", letterSpacing: 0.4, marginBottom: 10 },
  ...
  tagText: { fontFamily: "Manrope", fontSize: 11, fontWeight: "500" },
  ...
  attrLabel: { fontFamily: "Manrope", fontSize: 9, fontWeight: "500", letterSpacing: 0.8, textTransform: "uppercase", marginBottom: 4 },
  attrValue: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600", lineHeight: 16 },
  section: { paddingHorizontal: 20, marginBottom: 20 },
  sectionTitle: { fontFamily: "Manrope", fontSize: 11, fontWeight: "700", letterSpacing: 1, textTransform: "uppercase", marginBottom: 12 },
  para: { fontFamily: "Manrope", fontSize: 13, lineHeight: 21, marginBottom: 12 },
  ...
  ctaText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700", color: "#0B0F14" },
