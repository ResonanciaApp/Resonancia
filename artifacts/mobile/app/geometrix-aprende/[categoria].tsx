  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={[styles.hero, { backgroundColor: colors.primary + "0A" }]}>
        ...
        <Text style={[styles.heroDesc, { color: "#a79fb8" }]}>{meta?.desc}</Text>
      </View>
          ...
          return (
            ...
            >
              ...
              <View style={styles.itemText}>
                ...
                <Text style={[styles.itemSummary, { color: "#a79fb8" }]} numberOfLines={2}>{learn.summary}</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Manrope", flex: 1, fontSize: 18, fontWeight: "700" },
  countBadge: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  countText: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600" },
  hero: {
    flexDirection: "row", alignItems: "center", gap: 12,
    marginHorizontal: 20, marginBottom: 14,
    padding: 14, borderRadius: 12,
  },
  heroDesc: { fontFamily: "Manrope", flex: 1, fontSize: 12, lineHeight: 18 },
  ...
  itemName: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600", flexShrink: 1 },
  tag: { borderRadius: 6, paddingHorizontal: 6, paddingVertical: 1 },
  tagText: { fontFamily: "Manrope", fontSize: 10, fontWeight: "500" },
  itemSummary: { fontFamily: "Manrope", fontSize: 11, lineHeight: 16 },
});
