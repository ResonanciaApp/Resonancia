...
const styles = StyleSheet.create({
  ...
  confirmSubtitle: { fontSize: 13.5, color: "rgba(194,194,194,0.45)", textAlign: "center", lineHeight: 20 },
  ...
  btnGhostText: { fontSize: 14, fontWeight: "600", color: "rgba(194,194,194,0.45)" },
