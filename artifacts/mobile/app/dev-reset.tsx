...
const styles = StyleSheet.create({
  ...
  title: { color: "#FFFFFF", fontSize: 24, fontFamily: "OptimaBold" },
  body: { color: "rgba(237,225,211,0.65)", fontSize: 14, fontFamily: "Jost", lineHeight: 20 },
  btn: { borderRadius: 14, paddingVertical: 16, alignItems: "center", marginTop: 12 },
  btnText: { color: "#080F0A", fontFamily: "OptimaBold", fontSize: 15, letterSpacing: 0.3 },
  status: { color: "rgba(212,175,55,0.7)", fontSize: 12, fontFamily: "Jost", textAlign: "center" },
});
