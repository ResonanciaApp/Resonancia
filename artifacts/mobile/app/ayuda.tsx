...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: "Manrope", fontSize: 14, marginBottom: 24 },
  ...
  topicLabel: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600", lineHeight: 18 },
  faqTitle: { fontFamily: "Manrope", fontSize: 17, fontWeight: "700", marginBottom: 14 },
  ...
  faqQ: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600", lineHeight: 20 },
  faqA: { fontFamily: "Manrope", fontSize: 13, lineHeight: 20, marginTop: 12 },
  contactCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
  ...
  contactTitle: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600", marginBottom: 3 },
  contactSub: { fontFamily: "Manrope", fontSize: 12, lineHeight: 17 },
  contactBtn: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 7 },
  contactBtnText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600" },
});
