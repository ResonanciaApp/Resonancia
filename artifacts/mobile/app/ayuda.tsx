...
const TOPICS = [
  { icon: "credit-card" as const, label: "Pagos y facturación", color: "#f4c993" },
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Jost", marginBottom: 24 },
  ...
  topicLabel: { fontSize: 13, fontFamily: "Jost", fontWeight: "600", lineHeight: 18 },
  faqTitle: { fontSize: 17, fontFamily: "OptimaBold", marginBottom: 14 },
  ...
  faqQ: { fontSize: 14, fontFamily: "Jost", fontWeight: "600", lineHeight: 20 },
  faqA: { fontSize: 13, fontFamily: "Jost", lineHeight: 20, marginTop: 12 },
  contactCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
  ...
  contactTitle: { fontSize: 14, fontFamily: "Jost", fontWeight: "600", marginBottom: 3 },
  contactSub: { fontSize: 12, fontFamily: "Jost", lineHeight: 17 },
  contactBtn: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 7 },
  contactBtnText: { fontSize: 13, fontFamily: "Jost", fontWeight: "600" },
});
