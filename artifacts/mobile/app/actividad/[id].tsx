    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <LinearGradient colors={act.gradient} style={[styles.hero, { paddingTop: topPad + 20 }]}>
        ...
        <View style={styles.heroMeta}>
          <Feather name="map-pin" size={13} color="#F4F4F4" />
          <Text style={styles.heroMetaText}>{act.city}</Text>
          <Text style={styles.heroMetaSep}>·</Text>
          <Feather name="calendar" size={13} color="#F4F4F4" />
...
const styles = StyleSheet.create({
  ...
  typeBadgeText: { fontFamily: "Manrope", color: "#FFFFFF", fontSize: 11, fontWeight: "700", letterSpacing: 0.5 },
  heroTitle: { fontFamily: "Manrope", color: "#FFFFFF", fontSize: 24, fontWeight: "700", lineHeight: 30, marginBottom: 12 },
  heroMeta: { flexDirection: "row", alignItems: "center", gap: 6 },
  heroMetaText: { fontFamily: "Manrope", color: "#F4F4F4", fontSize: 12 },
  heroMetaSep: { fontFamily: "Manrope", color: "#F4F4F4", fontSize: 12 },
  // Chips
  chipsRow: { flexDirection: "row", gap: 10 },
  chip: { flex: 1, flexDirection: "row", alignItems: "center", gap: 10, borderRadius: 14, borderWidth: 1, padding: 14 },
  chipLabel: { fontFamily: "Manrope", fontSize: 10, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.3, marginBottom: 2 },
  chipValue: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700" },
  // Lugar
  ...
  lugarLabel: { fontFamily: "Manrope", fontSize: 10, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.3, marginBottom: 3 },
  lugarValue: { fontFamily: "Manrope", fontSize: 14, fontWeight: "500", lineHeight: 20 },
  mapaBtn: { flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 7 },
  mapaBtnText: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600" },
  // Content
  sectionTitle: { fontFamily: "Manrope", fontSize: 20, fontWeight: "700", letterSpacing: 0.5, marginBottom: 10 },
  description: { fontFamily: "Manrope", fontSize: 14, lineHeight: 23 },
  tagsRow: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  tag: { borderRadius: 20, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 5 },
  tagText: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600" },
  // Organizer
  ...
  orgInitials: { fontFamily: "Manrope", fontSize: 15, fontWeight: "700" },
  orgLabel: { fontFamily: "Manrope", fontSize: 11, marginBottom: 2 },
  orgName: { fontFamily: "Manrope", fontSize: 15, fontWeight: "700" },
  msgBtn: { flexDirection: "row", alignItems: "center", gap: 6, borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8 },
  msgBtnText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600" },
  // CTA bar
  ...
  ctaText: { fontFamily: "Manrope", fontWeight: "700", fontSize: 16, color: "#080F0A" },
  ctaConfirmed: { flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 16, borderWidth: 1.5, padding: 16 },
  ctaConfirmedTitle: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700" },
  ctaConfirmedSub: { fontFamily: "Manrope", fontSize: 12, marginTop: 2 },
  // Modal shared
  ...
  modalSub: { fontFamily: "Manrope", fontSize: 13, lineHeight: 19, marginBottom: 4 },
  modalForm: { gap: 10 },
  ...
  fieldInput: { fontFamily: "Manrope", flex: 1, fontSize: 14 },
  textAreaRow: { borderRadius: 14, borderWidth: 1, padding: 14, minHeight: 80 },
  textAreaInput: { fontFamily: "Manrope", fontSize: 14, lineHeight: 21 },
  ...
  modalBtnText: { fontFamily: "Manrope", color: "#080F0A", fontWeight: "700", fontSize: 16 },
  // Mensaje modal
  ...
  msgOrgInitials: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700" },
  msgOrgTo: { fontFamily: "Manrope", fontSize: 11, marginBottom: 2 },
  msgOrgName: { fontFamily: "Manrope", fontSize: 15, fontWeight: "700" },
  msgInputWrap: { borderRadius: 16, borderWidth: 1, padding: 14, minHeight: 120 },
  msgInput: { fontFamily: "Manrope", fontSize: 14, lineHeight: 22 },
  // Enviado
  ...
  sentTitle: { fontFamily: "Manrope", fontSize: 20, fontWeight: "700" },
  sentSub: { fontFamily: "Manrope", fontSize: 14, textAlign: "center", lineHeight: 21 },
  sentClose: { borderWidth: 1, borderRadius: 14, paddingHorizontal: 32, paddingVertical: 12, marginTop: 4 },
  sentCloseText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
});
