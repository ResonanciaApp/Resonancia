    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <LinearGradient colors={act.gradient} style={[styles.hero, { paddingTop: topPad + 20 }]}>
        ...
        <View style={styles.heroMeta}>
          <Feather name="map-pin" size={13} color="#EDE1D3AA" />
          <Text style={styles.heroMetaText}>{act.city}</Text>
          <Text style={styles.heroMetaSep}>·</Text>
          <Feather name="calendar" size={13} color="#EDE1D3AA" />
        ...
        {reservaEnviada ? (
          ...
          >
            <LinearGradient colors={["#D6A85B", "#C69B4F"]} style={styles.ctaGrad}>
              <Feather name="send" size={17} color="#1A0E06" />
      ...
      >
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
          ...
          <View style={[styles.modalSheet, { backgroundColor: colors.card, paddingBottom: bottomPad + 24 }]}>
            ...
            >
              <LinearGradient colors={["#D6A85B", "#C69B4F"]} style={styles.modalBtnGrad}>
...
const styles = StyleSheet.create({
  ...
  typeBadgeText: { color: "#EDE1D3", fontSize: 11, fontWeight: "700", letterSpacing: 0.5 },
  heroTitle: { color: "#EDE1D3", fontSize: 24, fontWeight: "700", lineHeight: 30, marginBottom: 12 },
  heroMeta: { flexDirection: "row", alignItems: "center", gap: 6 },
  heroMetaText: { color: "#EDE1D3AA", fontSize: 12 },
  heroMetaSep: { color: "#EDE1D3AA", fontSize: 12 },
  // Chips
  ...
  ctaText: { fontWeight: "700", fontSize: 16, color: "#1A0E06" },
  ...
  modalBtnText: { color: "#1A0E06", fontWeight: "700", fontSize: 16 },
  // Mensaje modal
