...
const styles = StyleSheet.create({
  ...
  typeBadgeText: { color: "#FFFFFF", fontSize: 11, fontFamily: "OptimaBold", letterSpacing: 0.5 },
  heroTitle: { color: "#FFFFFF", fontSize: 24, fontFamily: "OptimaBold", lineHeight: 30, marginBottom: 12 },
  heroMeta: { flexDirection: "row", alignItems: "center", gap: 6 },
  heroMetaText: { color: "rgba(244,218,213,0.55)", fontSize: 12, fontFamily: "Jost" },
  heroMetaSep: { color: "rgba(244,218,213,0.55)", fontSize: 12, fontFamily: "Jost" },
  // Chips
  chipsRow: { flexDirection: "row", gap: 10 },
  chip: { flex: 1, flexDirection: "row", alignItems: "center", gap: 10, borderRadius: 14, borderWidth: 1, padding: 14 },
  chipLabel: { fontSize: 10, fontFamily: "Jost", fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.3, marginBottom: 2 },
  chipValue: { fontSize: 13, fontFamily: "OptimaBold" },
  // Lugar
  ...
  lugarLabel: { fontSize: 10, fontFamily: "Jost", fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.3, marginBottom: 3 },
  lugarValue: { fontSize: 14, fontFamily: "Jost", fontWeight: "500", lineHeight: 20 },
  mapaBtn: { flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 7 },
  mapaBtnText: { fontSize: 12, fontFamily: "Jost", fontWeight: "600" },
  // Content
  sectionTitle: { fontSize: 16, fontFamily: "OptimaBold", marginBottom: 10 },
  description: { fontSize: 14, fontFamily: "Jost", lineHeight: 23 },
  tagsRow: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  tag: { borderRadius: 20, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 5 },
  tagText: { fontSize: 12, fontFamily: "Jost", fontWeight: "600" },
  // Organizer
  ...
  orgInitials: { fontSize: 15, fontFamily: "OptimaBold" },
  orgLabel: { fontSize: 11, fontFamily: "Jost", marginBottom: 2 },
  orgName: { fontSize: 15, fontFamily: "OptimaBold" },
  msgBtn: { flexDirection: "row", alignItems: "center", gap: 6, borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8 },
  msgBtnText: { fontSize: 13, fontFamily: "Jost", fontWeight: "600" },
  // CTA bar
  ...
  ctaText: { fontFamily: "OptimaBold", fontSize: 16, color: "#080F0A" },
  ctaConfirmed: { flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 16, borderWidth: 1.5, padding: 16 },
  ctaConfirmedTitle: { fontSize: 14, fontFamily: "OptimaBold" },
  ctaConfirmedSub: { fontSize: 12, fontFamily: "Jost", marginTop: 2 },
  // Modal shared
  ...
  modalTitle: { fontSize: 20, fontFamily: "OptimaBold" },
  modalSub: { fontSize: 13, fontFamily: "Jost", lineHeight: 19, marginBottom: 4 },
  modalForm: { gap: 10 },
  ...
  fieldInput: { flex: 1, fontSize: 14, fontFamily: "Jost" },
  textAreaRow: { borderRadius: 14, borderWidth: 1, padding: 14, minHeight: 80 },
  textAreaInput: { fontSize: 14, fontFamily: "Jost", lineHeight: 21 },
  ...
  modalBtnText: { color: "#080F0A", fontFamily: "OptimaBold", fontSize: 16 },
  // Mensaje modal
  ...
  msgOrgInitials: { fontSize: 14, fontFamily: "OptimaBold" },
  msgOrgTo: { fontSize: 11, fontFamily: "Jost", marginBottom: 2 },
  msgOrgName: { fontSize: 15, fontFamily: "OptimaBold" },
  msgInputWrap: { borderRadius: 16, borderWidth: 1, padding: 14, minHeight: 120 },
  msgInput: { fontSize: 14, fontFamily: "Jost", lineHeight: 22 },
  // Enviado
  ...
  sentTitle: { fontSize: 20, fontFamily: "OptimaBold" },
  sentSub: { fontSize: 14, fontFamily: "Jost", textAlign: "center", lineHeight: 21 },
  sentClose: { borderWidth: 1, borderRadius: 14, paddingHorizontal: 32, paddingVertical: 12, marginTop: 4 },
  sentCloseText: { fontSize: 14, fontFamily: "Jost", fontWeight: "600" },
});
