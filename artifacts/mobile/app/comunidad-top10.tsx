...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontFamily: "Manrope", fontSize: 28, fontWeight: "700", letterSpacing: 0.5, marginBottom: 4 },
  ...
  rankText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700" },
  cardWrap: { flex: 1 },
  plays: { fontFamily: "Manrope", fontSize: 11, marginTop: 4, marginLeft: 4, letterSpacing: 0.3 },
});
