...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600", letterSpacing: 0.4, textTransform: "uppercase", marginBottom: 8, marginTop: 16 },
  ...
  tipoLabel: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700" },
  tipoDesc: { fontFamily: "Manrope", fontSize: 10, textAlign: "center" },
  inputRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  previewBtnText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
  ...
  typeBadgeText: { fontFamily: "Manrope", fontSize: 12, fontWeight: "700" },
  previewTitle: { fontFamily: "Manrope", fontSize: 20, fontWeight: "700", lineHeight: 26 },
  previewDesc: { fontFamily: "Manrope", fontSize: 14, lineHeight: 21 },
  previewMeta: { gap: 8 },
  metaRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  metaText: { fontFamily: "Manrope", fontSize: 13 },
  ...
  orgInitials: { fontFamily: "Manrope", fontSize: 11, fontWeight: "700" },
  orgName: { fontFamily: "Manrope", fontSize: 13 },
  previewHint: { fontFamily: "Manrope", fontSize: 12, textAlign: "center", lineHeight: 18, marginBottom: 24 },
});
