...
const styles = StyleSheet.create({
  ...
  screenTitle: { fontSize: 17, fontFamily: "OptimaBold" },
  label: { fontSize: 12, fontFamily: "Jost", fontWeight: "600", letterSpacing: 0.4, textTransform: "uppercase", marginBottom: 8, marginTop: 16 },
  ...
  tipoLabel: { fontSize: 13, fontFamily: "OptimaBold" },
  tipoDesc: { fontSize: 10, fontFamily: "Jost", textAlign: "center" },
  inputRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  inputText: { flex: 1, fontSize: 14, fontFamily: "Jost" },
  textArea: { borderRadius: 14, borderWidth: 1, padding: 14, minHeight: 100 },
  textAreaInput: { fontSize: 14, fontFamily: "Jost", lineHeight: 22 },
  selectRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  selectText: { fontSize: 14, fontFamily: "Jost" },
  dropdown: {
    borderRadius: 14,
    borderWidth: 1,
    overflow: "hidden",
  ...
  dropdownText: { fontSize: 14, fontFamily: "Jost" },
  ...
  previewBtnText: { fontSize: 14, fontFamily: "OptimaBold" },
  ...
  publishText: { color: "#080F0A", fontFamily: "OptimaBold", fontSize: 16 },
  // Preview styles
  ...
  typeBadgeText: { fontSize: 12, fontFamily: "OptimaBold" },
  previewTitle: { fontSize: 20, fontFamily: "OptimaBold", lineHeight: 26 },
  previewDesc: { fontSize: 14, fontFamily: "Jost", lineHeight: 21 },
  previewMeta: { gap: 8 },
  metaRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  metaText: { fontSize: 13, fontFamily: "Jost" },
  ...
  orgInitials: { fontSize: 11, fontFamily: "OptimaBold" },
  orgName: { fontSize: 13, fontFamily: "Jost" },
  previewHint: { fontSize: 12, fontFamily: "Jost", textAlign: "center", lineHeight: 18, marginBottom: 24 },
});
