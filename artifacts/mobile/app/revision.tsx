...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontFamily: "Manrope", fontSize: 16, fontWeight: "700" },
  cardSub: { fontFamily: "Manrope", fontSize: 13, marginTop: 2 },
  cardMeta: { fontFamily: "Manrope", fontSize: 12, marginTop: 4 },
  cardDesc: { fontFamily: "Manrope", fontSize: 13, lineHeight: 19, marginTop: 10 },
  assetLine: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  assetText: { fontFamily: "Manrope", fontSize: 12 },
  ...
  rejectText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700" },
  approveBtn: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  approveText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700", color: "#06130C" },
  ...
  backBtnText: { fontFamily: "Manrope", fontSize: 14, fontWeight: "600" },
  modalBackdrop: {
    flex: 1,
