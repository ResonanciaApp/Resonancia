...
export default function ResonadorPerfilScreen() {
  ...
  const bgColors: readonly [string, string] = bgGradientColors(profileBgId) ?? ["#230610", "#16040A"];
...
const styles = StyleSheet.create({
  ...
  sectionBlock: { gap: 10 },
  sectionTitle: { fontSize: 20, fontWeight: "700", color: "#FAF0EE", letterSpacing: 0.5 },
