  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        {sessions.length > 0 && (
          <View style={[styles.card, { marginHorizontal: H_PAD, backgroundColor: "transparent", paddingHorizontal: 0, marginTop: 19 }]}>
        ...
        {resonador.projects && resonador.projects.length > 0 && (
          <View style={[styles.card, { marginHorizontal: H_PAD, marginTop: 19 }]}>
        ...
        {/* Quote */}
        {resonador.quote ? (
          <View style={[styles.quoteWrap, { marginHorizontal: H_PAD, marginTop: 19 }]}>
