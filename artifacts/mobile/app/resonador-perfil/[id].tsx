  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        {/* ── Sección Resonador ── */}
        <View style={[styles.resonadorSection, { marginHorizontal: H_PAD, marginTop: 42 }]}>
        ...
        {(() => {
          ...
          if (customPhotos.length > 0) {
            return (
              <View style={[styles.photoGrid, { marginHorizontal: H_PAD, marginTop: 45 }]}>
        ...
        {resonador.projects && resonador.projects.length > 0 && (
          <View style={[styles.card, { marginHorizontal: H_PAD, marginTop: 26 }]}>
...
const styles = StyleSheet.create({
  ...
  agendaIconCircle: {
    ...
    height: 36,
    borderRadius: 18,
    backgroundColor: "rgba(130,96,181,0.1)",
    alignItems: "center",
    justifyContent: "center",
  },
  agendaAvailText: {
