...
export default function MezclasComunidadScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: theme.gradient[theme.gradient.length - 1] as string }]}>
      ...
      <Animated.ScrollView
        style={styles.scroll}
        contentContainerStyle={{ paddingBottom: 60 + bottomPad, paddingTop: topPad + 4 }}
          ...
          <View style={styles.titleRow}>
            ...
            >
              <Pressable
                ...
                style={[styles.creaBtn, { backgroundColor: "rgba(255,255,255,0.045)" }]}
              >
...
const styles = StyleSheet.create({
  ...
  chip: { minWidth: 96, paddingHorizontal: 14, height: 31, borderRadius: 999, overflow: "hidden", alignItems: "center", justifyContent: "center" },
