...
const SHARE_OPTIONS = [
  ...
  { icon: "mail" as const, label: "Email", color: "#F9F9F9" },
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Manrope", fontSize: 26, fontWeight: "700", marginBottom: 10, textAlign: "center" },
  subtitle: { fontFamily: "Manrope", fontSize: 14, textAlign: "center", lineHeight: 21 },
  inviteCard: {
    borderRadius: 20,
    borderWidth: 1,
    padding: 22,
  ...
  inviteLabel: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600" },
  inviteCode: { fontFamily: "Manrope", fontSize: 26, fontWeight: "700", letterSpacing: 3 },
  copyBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  copyText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "600" },
  howBlock: {
    borderRadius: 18,
    borderWidth: 1,
    padding: 20,
  ...
  howTitle: { fontFamily: "Manrope", fontSize: 14, fontWeight: "700", marginBottom: 4 },
  ...
  howNumText: { fontFamily: "Manrope", fontSize: 13, fontWeight: "700" },
  howText: { fontFamily: "Manrope", flex: 1, fontSize: 14, lineHeight: 20 },
  shareLabel: { fontFamily: "Manrope", fontSize: 12, fontWeight: "600", letterSpacing: 0.5, textTransform: "uppercase", marginBottom: 14 },
  ...
  shareBtnLabel: { fontFamily: "Manrope", fontSize: 11, fontWeight: "600" },
});
