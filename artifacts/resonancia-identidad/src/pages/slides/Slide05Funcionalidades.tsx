  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <h2 style={{ fontSize: "3vw", fontWeight: 300, color: "#EDE1D3", margin: 0, letterSpacing: "-0.02em" }}>
            Funcionalidades <span style={{ fontWeight: 700, color: "#BE9650" }}>clave</span>
          </h2>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", gap: "3.5vh" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "0.6vw", backgroundColor: "rgba(190, 150, 80,0.12)", border: "1px solid rgba(190, 150, 80,0.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <div style={{ width: "1vw", height: "1vw", borderRadius: "50%", backgroundColor: "#BE9650" }} />
            </div>
            <div>
              <div style={{ fontSize: "2vw", fontWeight: 600, color: "#EDE1D3", marginBottom: "0.5vh" }}>Biblioteca de sesiones</div>
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>30+ sesiones en 5 categorías: Sonidos Ancestrales, Meditaciones Guiadas, Música, ASMR e Historias.</div>
            </div>
          </div>

          <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "0.6vw", backgroundColor: "rgba(190, 150, 80,0.12)", border: "1px solid rgba(190, 150, 80,0.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <div style={{ width: "1vw", height: "0.35vh", backgroundColor: "#BE9650", borderRadius: "2px" }} />
            </div>
            <div>
              <div style={{ fontSize: "2vw", fontWeight: 600, color: "#EDE1D3", marginBottom: "0.5vh" }}>Reproductor inmersivo</div>
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>Arte circular, timer personalizable, control independiente de voz y ambiente.</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "0.6vw", backgroundColor: "rgba(190, 150, 80,0.12)", border: "1px solid rgba(190, 150, 80,0.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <svg viewBox="0 0 20 20" width="1.1vw" height="1.1vw">
                <path d="M10 3 C10 3 4 7 4 12 C4 15.3 6.7 18 10 18 C13.3 18 16 15.3 16 12 C16 7 10 3 10 3Z" stroke="#BE9650" fill="none" strokeWidth="1.5"/>
              </svg>
            </div>
            <div>
              <div style={{ fontSize: "2vw", fontWeight: 600, color: "#EDE1D3", marginBottom: "0.5vh" }}>Mi Música — Mixer</div>
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>36 sonidos ambiente para combinar: naturaleza, agua, cuencos, frecuencias binaurales.</div>
            </div>
          </div>

          <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "0.6vw", backgroundColor: "rgba(190, 150, 80,0.12)", border: "1px solid rgba(190, 150, 80,0.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <div style={{ width: "1vw", height: "1vw", borderRadius: "2px", border: "0.15vw solid #BE9650" }} />
            </div>
            <div>
              <div style={{ fontSize: "2vw", fontWeight: 600, color: "#EDE1D3", marginBottom: "0.5vh" }}>Perfil y progreso</div>
              <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>Racha diaria, minutos escuchados, diario, favoritos y mezclas guardadas.</div>
            </div>
          </div>
      ...
      <div style={{ width: "48vw", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at center, rgba(190, 150, 80,0.05) 0%, rgba(6, 10, 15,0) 65%)" }} />
        <div style={{
          ...
          <div style={{ width: "100%", height: "100%", borderRadius: "2.05vw", overflow: "hidden", backgroundColor: "#060A0F" }}>
            <img
