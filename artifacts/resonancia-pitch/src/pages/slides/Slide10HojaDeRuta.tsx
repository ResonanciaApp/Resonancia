    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "66vw" }}>
          El camino a <span style={{ color: "#BE9650" }}>las tiendas.</span>
        </div>
      </div>

      {/* Four steps */}
      <div style={{ display: "flex", gap: "2vw" }}>
        <div style={{ flex: 1, borderTop: "2px solid #BE9650", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, color: "#BE9650", marginBottom: "1vh" }}>01</div>
          <div style={{ fontSize: "1.8vw", fontWeight: 700, color: "#EDE1D3", marginBottom: "1vh" }}>Cobros</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.45 }}>
            Activar suscripciones con RevenueCat y definir precios por región.
          </div>
        </div>
        <div style={{ flex: 1, borderTop: "2px solid #BE9650", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, color: "#BE9650", marginBottom: "1vh" }}>02</div>
        ...
        <div style={{ flex: 1, borderTop: "2px solid #BE9650", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, color: "#BE9650", marginBottom: "1vh" }}>03</div>
        ...
        <div style={{ flex: 1, borderTop: "2px solid #BE9650", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, color: "#BE9650", marginBottom: "1vh" }}>04</div>
