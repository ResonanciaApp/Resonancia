    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "66vw" }}>
          El camino a <span style={{ background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>las tiendas.</span>
        </div>
      </div>

      {/* Four steps */}
      <div style={{ display: "flex", gap: "2vw" }}>
        <div style={{ flex: 1, borderTop: "2px solid #F7CB6B", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: "1vh" }}>01</div>
        ...
        <div style={{ flex: 1, borderTop: "2px solid #F7CB6B", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: "1vh" }}>02</div>
        ...
        <div style={{ flex: 1, borderTop: "2px solid #F7CB6B", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: "1vh" }}>03</div>
        ...
        <div style={{ flex: 1, borderTop: "2px solid #F7CB6B", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "2.6vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: "1vh" }}>04</div>
