export default function SlideTramosInversion() {
  ...
  const VAL_M12 = 690; // millones CLP · 5.000 subs × $2.881 ARR rec. × 12 × 4×
    ...
    >
      ...
      <div style={{ flexShrink: 0, borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: "1.5vh" }}>
        <div style={{ fontSize: "1.0vw", color: "rgba(244,244,244,0.32)", lineHeight: 1.5 }}>
          Stake M12 calculado sobre ARR recurrente (5.000 suscriptores × $2.881 ARPU rec. × 12 meses × 4× = $690M CLP) · Excluye lifetime (no recurrente) · Retorno estimado ilustrativo, no garantizado.
        </div>
      </div>
