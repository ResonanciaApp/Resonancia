    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "66vw" }}>
          Un refugio de sonido, <span style={{ color: "#BE9650" }}>nativo en español.</span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: "2.5vw" }}>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3.5vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "2vw", fontWeight: 700, color: "#BE9650", marginBottom: "1.5vh" }}>Voz propia</div>
          <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.5 }}>
            Meditaciones, historias y voces guía creadas en español neutro, no traducidas.
          </div>
        </div>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3.5vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "2vw", fontWeight: 700, color: "#BE9650", marginBottom: "1.5vh" }}>Sonido ancestral</div>
          <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.5 }}>
            Cuencos, frecuencias binaurales y música ambiente curada por artistas certificados.
          </div>
        </div>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3.5vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "2vw", fontWeight: 700, color: "#BE9650", marginBottom: "1.5vh" }}>Comunidad</div>
          <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.5 }}>
      ...
      {/* Closing line */}
      <div style={{ fontSize: "1.7vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.5, maxWidth: "72vw" }}>
