    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "62vw" }}>
          La salud mental en español está <span style={{ color: "#C69B4F" }}>desatendida.</span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "3vh" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: "2.5vw", borderTop: "1px solid #3a2a1c", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "4.5vw", fontWeight: 700, color: "#C69B4F", width: "16vw", lineHeight: 1 }}>22%</div>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: "2.5vw", borderTop: "1px solid #3a2a1c", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "4.5vw", fontWeight: 700, color: "#C69B4F", width: "16vw", lineHeight: 1 }}>2,8%</div>
          <div style={{ fontSize: "2vw", fontWeight: 400, color: "#cbb9a4", lineHeight: 1.45, maxWidth: "58vw" }}>
