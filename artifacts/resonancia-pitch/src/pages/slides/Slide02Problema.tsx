    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "62vw" }}>
          La salud mental en español está <span style={{ background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>desatendida.</span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "3vh" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: "2.5vw", borderTop: "1px solid #3D0E16", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "4.5vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", width: "16vw", lineHeight: 1 }}>22%</div>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: "2.5vw", borderTop: "1px solid #3D0E16", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "4.5vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", width: "16vw", lineHeight: 1 }}>2,8%</div>
          <div style={{ fontSize: "2vw", fontWeight: 400, color: "rgba(242,231,228,0.50)", lineHeight: 1.45, maxWidth: "58vw" }}>
            del presupuesto de salud de la región se destina a salud mental.
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "baseline", gap: "2.5vw", borderTop: "1px solid #3D0E16", paddingTop: "2.5vh" }}>
          <div style={{ fontSize: "4.5vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", width: "16vw", lineHeight: 1 }}>+80%</div>
          <div style={{ fontSize: "2vw", fontWeight: 400, color: "rgba(242,231,228,0.50)", lineHeight: 1.45, maxWidth: "58vw" }}>
