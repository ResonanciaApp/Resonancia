  ...
  return (
    ...
    >
      ...
      >
        {/* Brand mark */}
        <div>
          <div style={{ fontSize: "1.5vw", fontWeight: 700, letterSpacing: "-0.05em", color: "#D4AF37", marginBottom: "1vh" }}>
            RESONANCIA
          </div>
        ...
        <div>
          ...
          <div style={{ fontSize: "6vw", fontWeight: 700, lineHeight: 1.05, letterSpacing: "-0.04em", color: "#D4AF37", marginBottom: "4vh" }}>
