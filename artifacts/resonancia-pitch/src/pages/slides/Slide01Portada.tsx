  ...
  return (
    ...
    >
      ...
      >
        {/* Brand mark */}
        <div>
          <div style={{ fontSize: "1.5vw", fontWeight: 700, letterSpacing: "-0.05em", color: "#BE9650", marginBottom: "1vh" }}>
            RESONANCIA
          </div>
        ...
        {/* Hero title */}
        <div>
          <div style={{ fontSize: "1.8vw", fontWeight: 500, color: "#7A8FA8", letterSpacing: "0.12em", marginBottom: "2vh" }}>
            PRESENTACIÓN PARA INVERSIONISTAS
          </div>
          <div style={{ fontSize: "6vw", fontWeight: 300, lineHeight: 1.05, letterSpacing: "-0.04em", color: "#EDE1D3" }}>
            Tu refugio
          </div>
          <div style={{ fontSize: "6vw", fontWeight: 700, lineHeight: 1.05, letterSpacing: "-0.04em", color: "#BE9650", marginBottom: "4vh" }}>
            de sonido y presencia.
          </div>
          <div style={{ fontSize: "1.8vw", fontWeight: 400, color: "#7A8FA8", maxWidth: "38vw", lineHeight: 1.6 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ fontSize: "1.5vw", fontWeight: 500, color: "#7A8FA8" }}>
            iOS · Android
          </div>
        </div>
      </div>
      ...
      <div style={{ width: "50vw", height: "100vh", position: "relative", backgroundColor: "#060A0F", display: "flex", alignItems: "center", justifyContent: "center" }}>
        {/* Ambient glow */}
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 50% 50%, rgba(190, 150, 80,0.07) 0%, rgba(6, 10, 15,0) 65%)" }} />
