    ...
    >
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "3.5vh 5vw", borderBottom: "1px solid rgba(255,255,255,0.15)", zIndex: 2 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.8vw" }}>
          ...
          <span style={{ fontSize: "1.4vw", fontWeight: 700, color: "#FFFFFF" }}>02</span>
        </div>
      </div>
      ...
      <div style={{ position: "absolute", top: "13vh", left: "5vw", right: "5vw", bottom: "10vh", zIndex: 2 }}>
        ...
        <p style={{ fontSize: "1.1vw", color: "rgba(244,244,244,0.45)", margin: "0 0 3vh 0" }}>Expo Application Services — compilación nativa para App Store y Google Play.</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3vw" }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.8vw", marginBottom: "1.5vh" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "#FFFFFF" }} />
              <span style={{ fontSize: "0.8vw", fontWeight: 600, color: "#FFFFFF", letterSpacing: "0.12em", textTransform: "uppercase" }}>Listo en código</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.9vh" }}>
              {done.map((item, i) => (
                <div key={i} style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.13)", borderRadius: "0.6vw", padding: "1.4vh 1.5vw" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.8vw", marginBottom: "0.4vh" }}>
                    <span style={{ color: "#FFFFFF", fontSize: "0.9vw" }}>✅</span>
                    <span style={{ fontSize: "0.95vw", fontWeight: 600, color: "#F4F4F4" }}>{item.label}</span>
                  </div>
                  <div style={{ fontSize: "0.82vw", color: "rgba(244,244,244,0.45)", paddingLeft: "1.7vw" }}>{item.detail}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.8vw", marginBottom: "1.5vh" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "rgba(244,244,244,0.25)" }} />
              <span style={{ fontSize: "0.8vw", fontWeight: 600, color: "rgba(244,244,244,0.35)", letterSpacing: "0.12em", textTransform: "uppercase" }}>Pasos externos pendientes</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.9vh" }}>
              {pending.map((item, i) => (
                <div key={i} style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "0.6vw", padding: "1.4vh 1.5vw", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.8vw", marginBottom: "0.4vh" }}>
                      <span style={{ color: "rgba(244,244,244,0.25)", fontSize: "0.9vw" }}>⬜</span>
                      <span style={{ fontSize: "0.95vw", fontWeight: 600, color: "rgba(244,244,244,0.5)" }}>{item.label}</span>
                    </div>
                    <div style={{ fontSize: "0.82vw", color: "rgba(244,244,244,0.3)", paddingLeft: "1.7vw" }}>{item.detail}</div>
                  </div>
                  {item.cost && (
                    <span style={{ fontSize: "0.82vw", fontWeight: 700, color: "#FFFFFF", background: "rgba(255,255,255,0.1)", borderRadius: "0.4vw", padding: "0.3vh 0.7vw", whiteSpace: "nowrap", marginLeft: "1vw", flexShrink: 0 }}>{item.cost}</span>
                  )}
                </div>
              ))}
            </div>
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "2vh 5vw", borderTop: "1px solid rgba(0,0,0,0.27)", display: "flex", justifyContent: "space-between", zIndex: 2 }}>
        ...
        <span style={{ fontSize: "0.8vw", color: "rgba(244,244,244,0.25)" }}>3 / 6</span>
      </div>
    </div>
  );
}
