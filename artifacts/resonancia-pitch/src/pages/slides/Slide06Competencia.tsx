    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "70vw" }}>
          Los gigantes validan el modelo, <span style={{ color: "#BE9650" }}>pero no son nativos en español.</span>
        </div>
      </div>

      {/* Two columns */}
      <div style={{ display: "flex", gap: "2.5vw" }}>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3.5vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "2vw", fontWeight: 700, color: "#EDE1D3", marginBottom: "2vh" }}>Calm</div>
          <div style={{ fontSize: "3.2vw", fontWeight: 700, color: "#BE9650", lineHeight: 1 }}>~US$ 227M</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", marginBottom: "2vh" }}>ingresos anuales</div>
          <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.45 }}>
        ...
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3.5vh 2vw", boxSizing: "border-box" }}>
          ...
          <div style={{ fontSize: "3.2vw", fontWeight: 700, color: "#BE9650", lineHeight: 1 }}>~US$ 348M</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", marginBottom: "2vh" }}>ingresos anuales</div>
          <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.45 }}>
            ~2,8 millones de suscriptores pagos. Pensado en inglés; español traducido.
          </div>
        </div>
        <div style={{ flex: 1, border: "1.5px solid #BE9650", borderRadius: "1vw", padding: "3.5vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "2vw", fontWeight: 700, color: "#BE9650", marginBottom: "2vh" }}>RESONANCIA</div>
          <div style={{ fontSize: "3.2vw", fontWeight: 700, color: "#EDE1D3", lineHeight: 1 }}>Español</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", marginBottom: "2vh" }}>nativo, no traducido</div>
          <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.45 }}>
