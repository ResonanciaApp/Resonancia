export default function SlideFinanzas2() {
  ...
  // M1-M3: ARPU rec $2.408 + lifetime boost $1.176M/mes
  // M4+ : ARPU rec $3.116 + lifetime boost $1.765M/mes
  // Cursos M7+: neto $15.294/venta (post-tienda post-tallerista/prod 35%)
  const ARPU_LAUNCH = 2408;
  const ARPU_NORMAL = 3116;
  const LT_LAUNCH = 1.176;
  const LT_NORMAL = 1.765;
  ...
  const scenarios = [
    { label: "Base",      subs12: "5.000",  cursos6m: "600",    ingTotal: "~$124M", neto: "+$54M",  highlight: true  },
    { label: "Optimista", subs12: "7.000",  cursos6m: "~840",   ingTotal: "~$174M", neto: "+$104M", highlight: false },
    { label: "Agresivo",  subs12: "10.000", cursos6m: "~1.200", ingTotal: "~$249M", neto: "+$179M", highlight: false },
  ];
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "1.05vw", color: "rgba(244,244,244,0.40)", lineHeight: 1.5 }}>
        Blend 35/60/5% · ARPU rec. $2.408 (lanz.) / $3.116 (normal) · Cursos neto $15.294/venta (post-tienda, post-tallerista/prod 35%) ·
        Escenarios escalan proporcionalmente · Retorno estimado, no garantizado.
      </div>
    </div>
  );
}
