    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "4.2vw", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: "66vw" }}>
          No partimos de cero: ya tenemos <span style={{ color: "#BE9650" }}>una comunidad.</span>
        </div>
      </div>

      {/* Hero number */}
      <div style={{ display: "flex", alignItems: "baseline", gap: "1.5vw" }}>
        <div style={{ fontSize: "10vw", fontWeight: 700, color: "#BE9650", lineHeight: 0.9, letterSpacing: "-0.04em" }}>
          +1.000.000
        </div>
        <div style={{ fontSize: "2vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.3, maxWidth: "26vw" }}>
      ...
      <div style={{ display: "flex", gap: "2.5vw" }}>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "1.9vw", fontWeight: 700, color: "#BE9650", marginBottom: "1.2vh" }}>Canal propio</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>
            Un canal de lanzamiento propio: llegamos a cientos de miles de personas sin depender de la publicidad pagada.
          </div>
        </div>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "1.9vw", fontWeight: 700, color: "#BE9650", marginBottom: "1.2vh" }}>Costo de adquisición bajo</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>
            La audiencia ya existe y confía en la marca: cada nueva descarga cuesta una fracción de lo que paga la competencia.
          </div>
        </div>
        <div style={{ flex: 1, backgroundColor: "#090E17", borderRadius: "1vw", padding: "3vh 2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "1.9vw", fontWeight: 700, color: "#BE9650", marginBottom: "1.2vh" }}>Marca validada</div>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8", lineHeight: 1.5 }}>
      ...
      {/* Closing line */}
      <div style={{ fontSize: "1.6vw", fontWeight: 400, color: "#7A8FA8", lineHeight: 1.5, maxWidth: "82vw" }}>
