...
export default function SlideAnexoInversion() {
  return (
    <div
      ...
      style={{ backgroundColor: "#2E0D16", color: "#F4DAD5", padding: "5vh 6vw 4.5vh", boxSizing: "border-box" }}
    >
      {/* Header */}
      <div>
      ...
      <div style={{ display: "flex", gap: "3vw", flex: 1, minHeight: 0, marginTop: "2.5vh" }}>
        ...
        <div style={{ flex: 0.9, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "3.2vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", lineHeight: 1, marginBottom: "0.4vh" }}>US$ 570.000</div>
            ...
            <div style={{ borderTop: "1px solid rgba(212,175,55,0.2)", paddingTop: "1vh", marginTop: "auto" }}>
              <div style={{ fontSize: "0.95vw", color: "rgba(242,231,228,0.50)", marginBottom: "0.5vh" }}>
                US$30.000 ÷ post-money US$600K ≈ <span style={{ background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontWeight: 700 }}>5,0%</span>
              </div>
              <div style={{ display: "flex", gap: "0.8vw" }}>
                <div style={{ flex: 1, backgroundColor: "rgba(212,175,55,0.08)", borderRadius: "0.4vw", padding: "0.6vh 0.6vw", textAlign: "center" }}>
                  <div style={{ fontSize: "0.85vw", color: "#3D0E16" }}>Ticket</div>
                  <div style={{ fontSize: "1.25vw", fontWeight: 700, color: "#F4DAD5" }}>US$ 30K</div>
                  <div style={{ fontSize: "0.78vw", color: "#3D0E16" }}>$27M CLP</div>
                </div>
                <div style={{ flex: 1, backgroundColor: "rgba(212,175,55,0.08)", borderRadius: "0.4vw", padding: "0.6vh 0.6vw", textAlign: "center" }}>
                ...
                <div style={{ flex: 1, backgroundColor: "rgba(212,175,55,0.08)", borderRadius: "0.4vw", padding: "0.6vh 0.6vw", textAlign: "center" }}>
                  ...
                  <div style={{ fontSize: "0.78vw", color: "#3D0E16" }}>$540M CLP</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style={{ flex: 1.7, display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: "0.95vw", fontWeight: 700, background: "linear-gradient(90deg, #F7CB6B, #FBA980)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", letterSpacing: "0.1em", marginBottom: "1vh" }}>VALORACIÓN ESTIMADA · MES 12</div>
