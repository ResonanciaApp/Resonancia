export default function SlideFinanzas1() {
  ...
  const rows = [
    { mes: "M1 Lanzamiento", subs: "400",   ingreso: "$1,5M",  upsell: "—",      costoFijo: "$3,9M", costoVar: "$0",    resultado: "–$2,4M", neg: true  },
    { mes: "Mes 2",          subs: "800",   ingreso: "$3,0M",  upsell: "—",      costoFijo: "$3,9M", costoVar: "$0",    resultado: "–$0,9M", neg: true  },
    { mes: "Mes 3",          subs: "1.200", ingreso: "$4,5M",  upsell: "—",      costoFijo: "$4,4M", costoVar: "$1,2M", resultado: "–$1,1M", neg: true  },
    { mes: "Mes 4",          subs: "1.600", ingreso: "$6,0M",  upsell: "—",      costoFijo: "$4,4M", costoVar: "$1,2M", resultado: "+$0,4M", neg: false },
    { mes: "Mes 9",          subs: "3.600", ingreso: "$13,5M", upsell: "+$2,4M", costoFijo: "$5,2M", costoVar: "$1,5M", resultado: "+$9,2M", neg: false },
    { mes: "Mes 12",         subs: "5.000", ingreso: "$18,8M", upsell: "+$3,1M", costoFijo: "$5,4M", costoVar: "$1,5M", resultado: "+$15,0M", neg: false },
  ];
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ fontSize: "0.95vw", color: "rgba(244,244,244,0.50)", lineHeight: 1.3 }}>
          ...
          <strong style={{ color: "#F4F4F4" }}> Break-even operacional: Mes 4. Up-sells de cursos desde Mes 7.</strong>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: "1.3vw", fontWeight: 700, color: "#F4F4F4" }}>~$118M</div>
          ...
          <div style={{ fontSize: "1.4vw", fontWeight: 700, color: "#6EC49A" }}>+$62M neto</div>
        </div>
      </div>

      {/* Footnote */}
      <div style={{ fontSize: "1.1vw", color: "rgba(244,244,244,0.45)", lineHeight: 1.5 }}>
        Curva subs: +400/mes (M1=400…M12=5.000) · ARPU neto $3.750/mes (45% mensual $8.990 · 55% anual $49.990 · desc. IVA 19% + comisión tienda 30%) ·
        Fijos $3,9M/mes + mkt ramp ($0,5M→$1,5M) + contenido ($1,2M→$1,5M) ·
        Cursos/talleres: neto $23.529/venta · 600 ventas M7–M12 · ~$14M neto · Break-even operacional M4.
      </div>
