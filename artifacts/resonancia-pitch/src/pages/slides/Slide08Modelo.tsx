  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "2.5vw" }}>
        ...
        <div style={{ flex: 1, border: "1.5px solid #BE9650", borderRadius: "1vw", padding: "3.5vh 2.2vw", boxSizing: "border-box" }}>
          <div style={{ fontSize: "2.2vw", fontWeight: 700, color: "#BE9650", marginBottom: "2.2vh" }}>Premium</div>
          <div style={{ fontSize: "1.6vw", color: "#7A8FA8", lineHeight: 1.7 }}>
      ...
      <div style={{ display: "flex", gap: "4vw", alignItems: "baseline" }}>
        ...
        <div style={{ flex: 1, textAlign: "right" }}>
          <div style={{ fontSize: "1.5vw", color: "#7A8FA8" }}>Precios sugeridos</div>
          <div style={{ fontSize: "2vw", fontWeight: 700, color: "#BE9650" }}>[mensual] · [anual]</div>
        </div>
      </div>
    </div>
  );
