    ...
    <div className="relative w-screen h-screen overflow-hidden font-display" style={{ background: "linear-gradient(180deg, #2E0510 0%, #160108 100%)", color: "#F4DAD5" }}>
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", zIndex: 2 }}>
        ...
        <div style={{ width: "48vw", padding: "8vh 5vw 8vh 8vw", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: "1.1vw", fontWeight: 600, letterSpacing: "0.2em", color: "#D4AF37", marginBottom: "1.5vh" }}>EL ACTIVO QUE NO SE PUEDE COMPRAR</div>
            ...
            <div style={{ fontSize: "1.6vw", fontWeight: 400, lineHeight: 1.7, color: "rgba(244,218,213,0.6)", maxWidth: "36vw" }}>
          ...
          <div style={{ fontSize: "1.1vw", fontWeight: 400, letterSpacing: "0.12em", color: "rgba(244,218,213,0.25)" }}>06 / 12</div>
        </div>
        ...
        <div style={{ flex: 1, padding: "8vh 5vw 8vh 4vw", display: "flex", flexDirection: "column", justifyContent: "center", gap: "3.2vh" }}>
          {milestones.map((m) => (
            <div key={m.year} style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
              <div style={{ fontSize: "1.4vw", fontWeight: 700, color: "#D4AF37", width: "4vw", flexShrink: 0, marginTop: "0.1vh" }}>{m.year}</div>
              <div style={{ flex: 1, height: "1px", backgroundColor: "rgba(212,175,55,0.2)", marginTop: "1.1vh", marginRight: "1vw" }} />
              <div style={{ fontSize: "1.35vw", fontWeight: 400, color: "rgba(244,218,213,0.75)", flex: 2, lineHeight: 1.45 }}>{m.text}</div>
            </div>
          ))}
        </div>
      </div>
