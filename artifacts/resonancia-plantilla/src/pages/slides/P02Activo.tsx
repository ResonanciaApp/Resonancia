  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden font-display" style={{ background: "linear-gradient(180deg, #2E0510 0%, #160108 100%)", color: "#F4DAD5" }}>
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", zIndex: 2 }}>
        ...
        {/* Left */}
        <div style={{ width: "44vw", padding: "8vh 4vw 8vh calc(8vw + 30px)", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
        ...
        {/* Right — attributes */}
        <div style={{ flex: 1, padding: "8vh calc(7vw + 30px) 8vh 4vw", display: "flex", flexDirection: "column", justifyContent: "flex-start", gap: "3.2vh" }}>
