    ...
    >
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column", padding: "6vh 7vw", zIndex: 2 }}>
          ...
          {profiles.map((p, i) => (
            ...
            >
              <div>
                ...
                {/* Context tag */}
                <div style={{ fontSize: "0.95vw", fontWeight: 500, color: "#D4AF37", letterSpacing: "0.04em", marginBottom: "2vh", opacity: 0.8 }}>
                  {p.context}
                </div>
        ...
        <div style={{ marginTop: "3vh", display: "flex", justifyContent: "flex-end" }}>
          <div style={{ fontSize: "1.1vw", fontWeight: 400, letterSpacing: "0.12em", color: "rgba(244,218,213,0.25)" }}>03 / 12</div>
        </div>
      </div>
    </div>
  );
