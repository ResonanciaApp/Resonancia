// Variante A — Borde fino sin relleno
export function ChipA() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6" style={{ background: "#130107" }}>
      <p style={{ color: "rgba(242,231,228,0.35)", fontSize: 11, letterSpacing: 2, textTransform: "uppercase", marginBottom: 4 }}>A — Borde fino</p>
