  ...
  return (
    ...
    >
      <style>{`
        ...
        .anim-scale-fade {
          animation: scaleFadeIn 260ms cubic-bezier(0.16, 1, 0.3, 1) both;
          transform-origin: top center;
        }
        .tab-btn2 { transition: color 200ms; }
        .tab-btn2:hover { opacity: 0.85; }
        .card-row2 { transition: background 150ms; }
        .card-row2:hover { background: #1c2333 !important; cursor: pointer; }
      `}</style>
      ...
      >
        ...
        >
          B — Fade + Escala Suave · 260ms spring
        </div>
      </div>
    </div>
  );
