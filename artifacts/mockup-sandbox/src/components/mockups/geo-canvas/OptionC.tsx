export function OptionC() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#1a1a2e]">
      <p className="text-white/50 text-xs mb-3 tracking-widest uppercase">Opción C — Profundo</p>
      <div
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, #C8CDD9, #B8BEC9, #A8AFBC)",
          }}
        />
      ...
      <p className="text-white/30 text-xs mt-3 font-mono">#C8CDD9 → #A8AFBC</p>
    </div>
  );
}
