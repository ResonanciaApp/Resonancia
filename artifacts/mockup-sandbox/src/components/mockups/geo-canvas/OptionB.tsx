export function OptionB() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#1a1a2e]">
      <p className="text-white/50 text-xs mb-3 tracking-widest uppercase">Opción B — Medio</p>
      <div
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, #D5DAE8, #C5CCDA, #B5BCCC)",
          }}
        />
      ...
      <p className="text-white/30 text-xs mt-3 font-mono">#D5DAE8 → #B5BCCC</p>
    </div>
  );
}
