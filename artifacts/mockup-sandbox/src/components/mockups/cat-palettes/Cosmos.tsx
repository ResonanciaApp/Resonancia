...
const cats = [
  { label: "Sonidos\nAncestales",  Icon: Disc2,  color: "#F2C144" },
  { label: "Meditaciones\nGuiadas", Icon: Eye,    color: "#A678E8" },
  { label: "Música y\nSonidos",    Icon: Music,   color: "#3DC9A0" },
  { label: "Podcast",              Icon: Mic2,    color: "#5B9EE8" },
];
...
export function Cosmos() {
  return (
    <div style={{ background: BG, minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 24px", fontFamily: "system-ui, sans-serif" }}>
      <p style={{ color: "#BE9650", fontSize: 11, letterSpacing: 3, textTransform: "uppercase", marginBottom: 8, fontWeight: 600 }}>Propuesta 2</p>
      <h2 style={{ color: "#EDE1D3", fontSize: 20, fontWeight: 700, marginBottom: 28, letterSpacing: 0.3 }}>Cosmos</h2>
