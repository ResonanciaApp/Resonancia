...
const cats = [
  { label: "Sonidos\nAncestales",  Icon: Disc2,  color: "#C4956A" },
  { label: "Meditaciones\nGuiadas", Icon: Eye,    color: "#8B82BE" },
  { label: "Música y\nSonidos",    Icon: Music,   color: "#5B9E7A" },
  { label: "Podcast",              Icon: Mic2,    color: "#6B9AB5" },
];
...
export function Niebla() {
  return (
    <div style={{ background: BG, minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 24px", fontFamily: "system-ui, sans-serif" }}>
      <p style={{ color: "#BE9650", fontSize: 11, letterSpacing: 3, textTransform: "uppercase", marginBottom: 8, fontWeight: 600 }}>Propuesta 3</p>
      <h2 style={{ color: "#EDE1D3", fontSize: 20, fontWeight: 700, marginBottom: 28, letterSpacing: 0.3 }}>Niebla</h2>
