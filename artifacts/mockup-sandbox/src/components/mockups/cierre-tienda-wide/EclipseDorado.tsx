    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-neutral-950 font-sans">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-20 w-full">
          ...
          {/* Main Content Area */}
          <div className="flex flex-col justify-center max-w-3xl mt-12 flex-grow">
            <h1
              className="text-7xl md:text-8xl leading-tight mb-8 font-['Playfair_Display']"
