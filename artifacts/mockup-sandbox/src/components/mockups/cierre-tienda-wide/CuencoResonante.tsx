      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-30 pointer-events-none">
          <svg width="1700" height="1700" viewBox="0 0 1700 1700" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="850" cy="850" r="130" stroke="url(#gold_grad)" strokeWidth="1" opacity="0.8" />
            <circle cx="850" cy="850" r="270" stroke="url(#gold_grad)" strokeWidth="1" opacity="0.6" />
            <circle cx="850" cy="850" r="410" stroke="url(#gold_grad)" strokeWidth="1.5" opacity="0.4" />
            <circle cx="850" cy="850" r="600" stroke="url(#gold_grad)" strokeWidth="1.5" opacity="0.2" />
            <circle cx="850" cy="850" r="800" stroke="url(#gold_grad)" strokeWidth="2" opacity="0.1" />

            <defs>
              <linearGradient id="gold_grad" x1="0" y1="0" x2="1700" y2="1700" gradientUnits="userSpaceOnUse">
        ...
        {/* Content */}
        <div className="z-10 flex flex-col items-center text-center max-w-5xl px-8">
          <div
            className="mb-10 text-[13px] tracking-[0.4em] uppercase font-light"
            style={{ color: "#BE9650" }}
          >
            Resonancia
          </div>
          ...
          <h1
            className="text-7xl md:text-8xl mb-8 font-serif leading-tight"
            style={{
              color: "#F4DAD5",
          ...
          <div className="flex flex-col items-center gap-6 mb-12">
            <div className="flex items-center gap-4">
              ...
              <span className="text-lg uppercase tracking-widest" style={{ color: "#D4AF37" }}>
          ...
          <button
            ...
            style={{ backgroundColor: "#BE9650", color: "#1B060F", fontWeight: 600 }}
          >
            Ver más
          </button>
        </div>
