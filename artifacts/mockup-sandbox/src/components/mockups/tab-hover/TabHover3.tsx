...
const BG = "#0B0F14", CREAM = "#EDE1D3", MUTED = "#7A8FA8";
...
export function TabHover3() {
  ...
  return (
    <div style={{ backgroundColor: BG, height: "100vh", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", padding: "0 28px", gap: 14 }}>
      <div style={{ color: MUTED, fontSize: 9, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase", fontFamily: "system-ui, sans-serif" }}>③ Borde crema/blanco</div>
