  ...
  return (
    <div style={{ background:"#1B060F", minHeight:"100vh", fontFamily:"system-ui,sans-serif" }}>
      <div style={{ background:`linear-gradient(to bottom, ${hc[0]}, ${hc[1]}, ${hc[2]})`, transition:"background 0.4s", padding:"44px 16px 0" }}>
        ...
        {/* BANNER D — Glow dorado */}
        <div style={{
          display:"flex", alignItems:"center", justifyContent:"space-between", gap:10,
          background:"rgba(212,175,55,0.05)", borderRadius:14, padding:"9px 14px", margin:"0 0 12px",
          ...
          <button style={{ flexShrink:0, fontSize:10, fontWeight:600, color:"#1B060F", background:"linear-gradient(135deg,#D4AF37,#E9C46A)", border:"none", borderRadius:20, padding:"6px 11px", cursor:"pointer", whiteSpace:"nowrap", boxShadow:"0 2px 10px rgba(212,175,55,0.3)" }}>
            ¿Cómo te sientes?
          </button>
        </div>
      </div>
      <div style={{ padding:"16px", color:"rgba(255,255,255,0.15)", fontSize:10, textAlign:"center" }}>D — Glow dorado • Toca los tabs para ver el cambio de fondo</div>
    </div>
  );
}
