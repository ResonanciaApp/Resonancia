  ...
  return (
    <div style={{ background:"#1B060F", minHeight:"100vh", fontFamily:"system-ui,sans-serif" }}>
      <div style={{ background:`linear-gradient(to bottom, ${hc[0]}, ${hc[1]}, ${hc[2]})`, transition:"background 0.4s", padding:"44px 16px 0" }}>
        ...
        {/* BANNER B — Glassmorphism */}
        <div style={{
          display:"flex", alignItems:"center", justifyContent:"space-between", gap:10,
          backdropFilter:"blur(14px)", WebkitBackdropFilter:"blur(14px)",
          background:"rgba(255,255,255,0.06)", border:"1px solid rgba(255,255,255,0.13)",
          borderRadius:14, padding:"9px 14px", margin:"0 0 12px",
          ...
          <button style={{ flexShrink:0, fontSize:10, fontWeight:600, color:"#E9C46A", background:"rgba(233,196,106,0.10)", border:"1px solid rgba(233,196,106,0.25)", borderRadius:20, padding:"5px 10px", cursor:"pointer", whiteSpace:"nowrap" }}>
            ¿Cómo te sientes?
          </button>
        </div>
      </div>
      <div style={{ padding:"16px", color:"rgba(255,255,255,0.15)", fontSize:10, textAlign:"center" }}>B — Glassmorphism • Toca los tabs para ver el cambio de fondo</div>
    </div>
  );
}
