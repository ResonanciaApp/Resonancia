...
const MandalaBackground = () => (
  <svg
    className="absolute -right-[15%] -top-[20%] w-[1100px] h-[1100px] pointer-events-none z-0"
    viewBox="0 0 100 100"
    fill="none"
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-neutral-950 font-sans">
      ...
      >
        ...
        {/* Header / Logo */}
        <div className="w-full pt-14 px-24 flex justify-between items-center z-10">
          <div className="text-[#BE9650] tracking-[0.45em] text-sm font-light">
            RESONANCIA
          </div>
        </div>

        {/* Main Content Column */}
        <div className="flex-1 w-full px-24 flex flex-col justify-center z-10 max-w-[900px]">
          <div className="mb-6">
          ...
          <h1 
            className="font-serif text-[5.5rem] leading-[1.05] text-[#F4DAD5] font-light mb-8"
