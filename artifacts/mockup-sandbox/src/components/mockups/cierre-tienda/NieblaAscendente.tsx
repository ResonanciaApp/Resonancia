  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-neutral-950 font-sans">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .fog-column:nth-child(1) { left: 10%; animation-duration: 18s; animation-delay: 0s; }
        .fog-column:nth-child(2) { left: 40%; animation-duration: 22s; animation-delay: -5s; width: 400px; background: radial-gradient(ellipse at center, rgba(212, 175, 55, 0.12) 0%, rgba(212, 175, 55, 0) 70%); }
        .fog-column:nth-child(3) { left: 70%; animation-duration: 20s; animation-delay: -10s; }
      `}} />
      ...
      >
        ...
        <div className="absolute inset-0 z-10 overflow-hidden mix-blend-screen">
          ...
          <div className="absolute bottom-0 left-1/4 w-[600px] h-[400px] bg-[#BE9650] opacity-20 blur-[100px] rounded-full translate-y-1/2" />
          <div className="absolute bottom-0 right-1/4 w-[500px] h-[300px] bg-[#D4AF37] opacity-15 blur-[120px] rounded-full translate-y-1/3" />
        </div>
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full px-20 text-center">
          ...
          <h1 className="text-[#F4DAD5] font-['Playfair_Display'] text-7xl md:text-8xl font-medium tracking-wide mb-6 drop-shadow-lg">
