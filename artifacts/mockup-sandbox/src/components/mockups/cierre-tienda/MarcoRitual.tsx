    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-neutral-950">
      ...
      >
        ...
        <div className="absolute top-16 left-0 right-0 flex justify-center">
          <span 
            className="tracking-[0.5em] text-sm uppercase opacity-70"
            style={{ color: '#BE9650' }}
          >
            RESONANCIA
          </span>
        ...
        {/* Content */}
        <div className="flex flex-col items-center justify-center text-center z-10 w-full max-w-4xl space-y-10 mt-8">
          
          {/* Overline */}
          <div className="flex flex-col items-center space-y-4">
            <span 
              className="uppercase tracking-[0.4em] text-sm font-medium"
              style={{ color: '#BE9650' }}
            >
              TRANSFORMACIÓN
            </span>
          ...
          <div className="space-y-6">
            <h1 
              className="text-7xl font-light font-['Playfair_Display',serif] leading-tight"
              style={{ 
                color: '#F4DAD5',
            ...
            <p 
              ...
              style={{ color: 'rgba(244,218,213,0.8)' }}
            >
