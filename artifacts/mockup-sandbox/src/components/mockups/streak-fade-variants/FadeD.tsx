...
export function FadeD() {
  return (
    <div style={{ background:BG, minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'0 20px', gap:12 }}>
      <p style={{ color:'rgba(255,255,255,0.4)', fontSize:10, letterSpacing:2, textTransform:'uppercase', margin:0 }}>D — 16px · suave</p>
      <StreakCard mask="linear-gradient(to bottom, transparent 0px, rgba(0,0,0,0.3) 6px, rgba(0,0,0,0.8) 12px, black 16px)" />
    </div>
  );
}
