...
function Card({ fade }: { fade: React.CSSProperties }) {
  ...
  return (
    <div style={{ position:'relative', width:'100%', maxWidth:360 }}>
      <div style={{
        ...
        border:`${0.5}px solid rgba(255,255,255,0.12)`,
        borderRadius:16, padding:'18px 14px 16px',
        display:'flex', flexDirection:'column', gap:13,
      }}>
        <div style={{ position:'relative', height:114, display:'flex', alignItems:'stretch' }}>
          <div style={{ position:'absolute', left:0, top:0, width:114, height:114, borderRadius:57, zIndex:2, flexShrink:0 }}>
          ...
          <div style={{
            ...
            border:`${0.5}px solid rgba(255,255,255,0.10)`,
            borderRadius:16, paddingLeft:114+27, paddingRight:14,
            ...
            return (
              <div key={i} style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:8, flex:1 }}>
                <div style={{
                  ...
                  backdropFilter:'blur(20px)', WebkitBackdropFilter:'blur(20px)',
                  background:'linear-gradient(180deg, rgba(255,255,255,0.07) 0%, rgba(255,255,255,0) 100%)',
                  border: (active||isToday) ? `1px solid rgba(200,180,120,0.5)` : `${0.5}px solid rgba(255,255,255,0.12)`,
      ...
      {/* FADE OVERLAY — C: 10px multi-stop (ease-out curve) */}
      <div style={{
...
export function FadeC() {
  return (
    <div style={{
      background: BG,
      minHeight:'100vh', display:'flex', flexDirection:'column',
      alignItems:'center', justifyContent:'center', padding:'0 20px', gap:12,
    }}>
      <p style={{ color:'rgba(255,255,255,0.4)', fontSize:10, letterSpacing:2, textTransform:'uppercase', margin:0 }}>
        C — Fade 10px · multi-stop curvo
      </p>
      <Card fade={{
        height: '10px',
        background: `linear-gradient(to bottom, ${BG} 0%, rgba(27,6,15,0.55) 45%, transparent 100%)`,
      }}/>
    </div>
  );
}
